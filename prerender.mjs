...
const rotasEstaticas = [
  ...
  { path: 'sobre', title: 'Sobre Marco Aurélio Jr. | Nutrição com Marco', image: `${githubImgBase}logoN_pingus.webp`, desc: 'Conheça a história de Marco Aurélio Jr., futuro nutricionista e especialista em avaliação física ISAK 1.', schemasExtra: [getVideoSchema("Estudante de Jornalismo Entrevista Futuro Nutricionista: A Verdade Sobre as Dietas!", "Entrevista da estagiária de jornalismo Liliane com Marco Aurélio, futuro nutricionista, sobre o projeto Nutrição com Marco, mitos comuns da nutrição e o que é uma avaliação antropométrica.", "W-tSb-iwij4", "2026-09-16T12:00:06-07:00")] },
...
{ id: 37, link: "/como-calcular-meu-get", img: `${githubImgBase}Blog/GET_Capa.webp`, titulo: "Como Calcular Meu GET (Gasto Energético Total)", desc: "Aprenda de verdade como calcular meu get com equações validadas (Mifflin e Harris-Benedict). Acesse nossa calculadora gratuita e descubra sua TMB exata.", data: "2026-09-05", schemasExtra: [getMedicalSchema("Fisiologia do Metabolismo e Gasto Calórico", "https://www.nutricaocommarco.com.br/como-calcular-meu-get", ["Taxa Metabólica Basal", "Gasto Energético Total", "Equação de Mifflin-St Jeor"])] },
{
    ...
    schemasExtra: [
      getMedicalSchema("Microplásticos, Saúde e Fertilidade Humana", "https://www.nutricaocommarco.com.br/o-que-sao-microplasticos", ["Microplásticos", "Nanoplásticos", "Disrupção Endócrina", "Fertilidade", "Saúde Ambiental", "Saúde Mental"], "Toxicology"),
  ...
  },
{
    ...
    schemasExtra: [
      ...
      getVideoSchema("Estudante de Jornalismo Entrevista Futuro Nutricionista: A Verdade Sobre as Dietas!", "Trecho da entrevista em que Marco Aurélio explica o que é antropometria e por que a balança sozinha não mostra quanto de gordura e de músculo o corpo tem.", "W-tSb-iwij4", "2026-09-16T12:00:06-07:00"),
      getFaqSchema([
