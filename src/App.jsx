          ...
          <section id="sobre" className="py-24 bg-white">
            <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-16">
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-lg text-slate-600 leading-relaxed mb-8 font-medium">Sou estudante do 4º ano de Nutrição na Unicesumar e um entusiasta da antropometria técnica. Minha missão é levar clareza nutricional para quem busca resultados reais através de ciência e precisão.</p>
                
                {/* ATUALIZAÇÃO DO FOCO E LOCAL */}
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-5 bg-slate-50 rounded-2xl border border-green-50 text-center md:text-left">
                    <h4 className="font-black text-green-600 text-sm uppercase mb-1">Foco</h4>
                    <p className="font-bold text-slate-800">Antropometria e Emagrecimento</p>
                  </div>
                  <div className="p-5 bg-slate-50 rounded-2xl border border-green-50 text-center md:text-left">
                    <h4 className="font-black text-green-600 text-sm uppercase mb-1">Local</h4>
              ...
              <div className="flex flex-wrap justify-center gap-8 max-w-7xl mx-auto">
                {[
                  ...
                  <a key={i} href={ebook.link} target="_blank" rel="noreferrer" className="w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.33%-1.5rem)] max-w-[360px] bg-white p-8 rounded-[3rem] shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all flex flex-col group border border-slate-100">
                    ...
                    <h3 className="text-2xl font-black mb-4 min-h-[64px] text-slate-800 text-center md:text-left">{ebook.title}</h3>
        ...
        <section className="pt-40 pb-24 min-h-screen bg-slate-50 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-24">
              <div>
                <h2 className="text-2xl font-black text-slate-800 uppercase italic mb-10 flex items-center gap-4 justify-center md:justify-start">
                  <span className="w-12 h-1 bg-green-600 rounded-full"></span> Formação Principal
                </h2>
                <div className="grid gap-8">
                  ...
                  <CertCard image={`${githubImgBase}isak-logo.png`} badge="Internacional" title="ISAK Level 1" org="ISAK" desc="Certificação mundial para padronização de medidas antropométricas de alta precisão baseada nos manuais de Norton e Olds." color="green" />
                </div>
              </div>

              <div>
                <h2 className="text-2xl font-black text-slate-800 uppercase italic mb-10 flex items-center gap-4 justify-center md:justify-start">
                  <span className="w-12 h-1 bg-green-600 rounded-full"></span> Prática Clínica e Comportamental
                </h2>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  <MiniCertCard image={`${githubImgBase}logo-temporaria.svg`} bgColor="bg-black" title="Farmacologia da Obesidade" org="Gustavo Stocker" desc="Estudo da farmacologia aplicada ao emagrecimento, otimizando resultados clínicos com base em evidências." />
                  <MiniCertCard image={`${githubImgBase}medsize_logo-branco-png.png`} bgColor="bg-black" title="Medsize Klinik" org="Medsize" desc="Focado em protocolos de atendimento e gestão clínica de alta performance." />
                  <MiniCertCard image={`${githubImgBase}antropometria-clínica-obesidade.jpg`} title="Antropometria na Obesidade" org="Icaro Andrade" desc="Técnicas de mensuração e avaliação específicas para o paciente com obesidade." />
                  ...
                  <MiniCertCard image={`${githubImgBase}pronutri.webp`} title="ProNutri (Ciclo 14)" org="Secad Artmed" desc="Novas evidências e condutas dietoterápicas modernas." />
                  ...
                  <MiniCertCard image={`${githubImgBase}ellocursos.webp`} title="Psicologia e Obesidade" org="Ellocursos Psicologia" desc="Trabalho de mudança de comportamentos e emoções." />
              ...
              <div className="grid md:grid-cols-2 gap-12 mb-24">
                <div>
                  <h2 className="text-2xl font-black text-slate-800 uppercase italic mb-10 flex items-center gap-4 justify-center md:justify-start">
                    <span className="w-12 h-1 bg-green-600 rounded-full"></span> Segurança Alimentar
                  </h2>
                ...
                <div>
                  <h2 className="text-2xl font-black text-slate-800 uppercase italic mb-10 flex items-center gap-4 justify-center md:justify-start">
                    <span className="w-12 h-1 bg-green-600 rounded-full"></span> Eventos
                  </h2>
                  <div className="bg-white p-8 rounded-[3rem] shadow-xl border border-slate-100 flex flex-col gap-6">
                    <div className="flex gap-6 items-center">
                      <div className="w-24 h-24 bg-white rounded-2xl shadow-md overflow-hidden p-2 border border-slate-50">
                        <img src={`${githubImgBase}simposio_obesidade.jpg`} className="w-full h-full object-contain" alt="Simpósio Hcor" />
                      </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                  <div onClick={() => openPost('antropometria')} className="bg-white rounded-[3rem] shadow-xl overflow-hidden cursor-pointer hover:-translate-y-2 transition-all group border border-slate-100">
                    <div className="h-64 overflow-hidden border-b border-slate-50">
                      <img src={`${githubImgBase}Blog/O_que_e_antropometria.png`} alt="Capa Antropometria" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                    </div>
                    <div className="p-8">
                      <span className="text-[10px] font-black bg-green-50 text-green-600 px-3 py-1 rounded-full uppercase tracking-widest text-center md:text-left">Ciência</span>
                      <h3 className="text-2xl font-black mt-4 leading-tight text-slate-800 text-center md:text-left">O que é Antropometria e por que ela é o GPS do seu corpo?</h3>
                  ...
                  <div onClick={() => openPost('bioimpedancia')} className="bg-white rounded-[3rem] shadow-xl overflow-hidden cursor-pointer hover:-translate-y-2 transition-all group border border-slate-100">
                    <div className="h-64 overflow-hidden border-b border-slate-50">
                      <img src={`${githubImgBase}Blog/Bia1.jpg`} alt="Capa Bioimpedância" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                    </div>
                    <div className="p-8">
                      <span className="text-[10px] font-black bg-green-50 text-green-600 px-3 py-1 rounded-full uppercase tracking-widest text-center md:text-left">Tecnologia</span>
                      <h3 className="text-2xl font-black mt-4 leading-tight text-slate-800 text-center md:text-left">A balança de bioimpedância é confiável? O que você precisa saber.</h3>
                      <div className="mt-6 flex items-center gap-2 text-green-600 font-bold uppercase text-xs justify-center md:justify-start">Ler Artigo Completo <ChevronRight size={16} /></div>
                    </div>
                  </div>
                </div>
              ...
              <div className="max-w-4xl mx-auto bg-white p-8 md:p-16 rounded-[4rem] shadow-2xl border border-slate-100">
                ...
                {selectedPost === 'antropometria' ? (
                  <article className="prose prose-lg max-w-none">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black mb-10 uppercase italic leading-tight text-slate-900 text-center md:text-left">O que é Antropometria?</h1>
                    <div className="space-y-6 text-lg text-slate-600 font-medium leading-relaxed">
                      <p>A <strong>Antropometria</strong> é uma ciência fundamental que estuda as proporções, o tamanho e as medidas do corpo humano...</p>
                      ...
                      <div className="my-12 rounded-[3rem] overflow-hidden shadow-2xl border border-slate-100 group">
                        ...
                        <div className="bg-green-50 p-4 text-center"><p className="text-xs text-green-700 font-bold uppercase tracking-widest text-center">A ciência da medida humana aplicada ao seu emagrecimento real.</p></div>
                      </div>

                      <h2 className="text-2xl font-black text-slate-900 uppercase italic mt-12 mb-4">Antropometria: A evolução da Ciência</h2>
                      <p>Historicamente, a preocupação com as formas corporais remonta aos antigos egípcios e gregos...</p>
                  ...
                  <article className="prose prose-lg max-w-none">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black mb-10 uppercase italic leading-tight text-slate-900 text-center md:text-left">A balança de bioimpedância é confiável?</h1>
                    ...
                    <div className="space-y-6 text-lg text-slate-600 font-medium leading-relaxed">
                      ...
                      <p>A bioimpedância funciona a partir da passagem de uma corrente elétrica de baixa intensidade pelo corpo. Essa corrente percorre os tecidos com diferentes níveis de resistência: a água conduz eletricidade com facilidade, enquanto a gordura oferece maior resistência.</p>

                      {/* IMAGEM COM SEO TRABALHADO */}
                      <div className="my-12 rounded-[3rem] overflow-hidden shadow-2xl border border-slate-100 group">
                        <img src={`${githubImgBase}Blog/Bia1.jpg`} alt="A balança de bioimpedância é confiável? Entenda a medição do percentual de gordura." title="Balança de Bioimpedância: Confiabilidade e Composição Corporal" className="w-full h-auto object-cover group-hover:scale-105 transition-transform duration-700" loading="lazy" />
                        <div className="bg-green-50 p-4 text-center"><p className="text-xs text-green-700 font-bold uppercase tracking-widest leading-relaxed text-center">Para entender se a balança de bioimpedância é confiável, é preciso saber que ela estima a composição corporal através da água.</p></div>
                      </div>
                      ...
                      <div className="bg-green-600 text-white p-10 rounded-[3.5rem] shadow-xl my-12 relative overflow-hidden">
                        ...
                        <h2 className="text-white text-2xl font-black uppercase italic mb-6 leading-tight text-center md:text-left">O que interfere no resultado?</h2>
                        <ul className="grid md:grid-cols-2 gap-4 list-none p-0 text-center md:text-left">
                          <li className="flex items-center justify-center md:justify-start gap-3"><CheckCircle size={20}/> Estado de hidratação</li>
                          <li className="flex items-center justify-center md:justify-start gap-3"><CheckCircle size={20}/> Consumo de cafeína/álcool</li>
                          <li className="flex items-center justify-center md:justify-start gap-3"><CheckCircle size={20}/> Exercício físico recente</li>
                          <li className="flex items-center justify-center md:justify-start gap-3"><CheckCircle size={20}/> Fase do ciclo menstrual</li>
                        </ul>
                      </div>
                      ...
                      <p>As chamadas balanças octapolares utilizam oito pontos de contato, reduzindo a margem de erro. No entanto, quando falamos de confiabilidade, a <strong>certificação ISAK</strong> é o diferencial. A antropometria técnica profissional tende a ser mais consistente ao longo do tempo.</p>
                ...
                <div className="mt-20 pt-10 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div><p className="font-bold text-slate-900 text-sm">Marco Aurélio Jr.</p><p className="text-xs text-slate-400 uppercase tracking-widest font-black">ISAK Level 1 • Nutrição com Ciência</p></div>
                  </div>
