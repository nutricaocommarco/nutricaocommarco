  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Guia completo sobre prebióticos: entenda a diferença para probióticos, descubra 12 alimentos ricos em fibras fermentáveis e saiba como nutrir seu intestino." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "author": {
              ...
              "knowsAbout": ["Nutrição", "Saúde Intestinal", "Microbiota", "Fibras Alimentares", "Composição Corporal"]
            },
            "publisher": {
              "@type": "Organization", 
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "about": [
              {"@type": "MedicalEntity", "name": "Prebióticos"},
              {"@type": "MedicalEntity", "name": "Microbiota Intestinal"},
              {"@type": "MedicalEntity", "name": "Saúde Intestinal"},
              {"@type": "MedicalEntity", "name": "Fibras Alimentares"}
            ],
            "audience": {
          ...
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": "Prebióticos: Para que servem?",
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "AudioObject",
            "name": "Áudio do Artigo: O que são Prebióticos?",
            "description": "Narração em áudio do artigo completo sobre prebióticos, saúde intestinal e alimentos fontes de fibras.",
            "contentUrl": "https://raw.githubusercontent.com/nutricaocommarco/nutricaocommarco/main/Audio/Prebioticos.mp3",
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "VideoObject",
            "name": "6 Alimentos Prebióticos",
            "description": "Neste vídeo curto e direto ao ponto, descubra 6 alimentos acessíveis e ricos em prebióticos para transformar a sua saúde intestinal hoje mesmo.",
            "thumbnailUrl": [
              "https://img.youtube.com/vi/ytMJD0TpEk0/maxresdefault.jpg"
            ],
            "uploadDate": "2024-01-10T08:00:00+00:00",
            "embedUrl": "https://www.youtube.com/embed/ytMJD0TpEk0",
            "contentUrl": "https://www.youtube.com/watch?v=ytMJD0TpEk0",
            "publisher": {
              "@type": "Organization",
              "name": "YouTube",
              "logo": {
