      ...
      <div className="bg-white p-8 md:p-16 rounded-[4rem] shadow-2xl border border-slate-100">
        ...
        <article className="prose prose-lg max-w-none">
            ...
            <nav className="bg-slate-50">
              ...
              <div className={`transition-all duration-500 ease-in-out ${isTocOpen ? 'max-h-[500px] opacity-100 border-t border-green-100/60' : 'max-h-0 opacity-0'} overflow-hidden bg-white`}>
                <ul className="p-5 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 list-none m-0">
                  ...
                  <li>
                    <a href="#interferencias" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0">
                      <AlertTriangle size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />
                      O Que Interfere
                    </a>
                  </li>
                  <li>
                    <a href="#frequencias" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0">
          ...
          <div className="space-y-6 text-lg text-slate-600 font-medium leading-relaxed text-left">
            ...
            <div className="my-8 p-6 md:p-8 bg-white border-l-4 border-green-600 shadow-md rounded-r-3xl flex flex-col gap-3 text-left">
              <h3 className="text-xl font-black text-slate-800 m-0 border-b border-slate-100 pb-3 flex items-center gap-2">
                <span className="text-green-700 text-2xl leading-none">👉</span> O que é o exame de bioimpedância?
              </h3>
          ...
          <figure className="my-12 rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl border border-slate-100 group flex flex-col bg-slate-200">
            ...
            <div className="bg-green-700 text-white p-10 rounded-[3.5rem] shadow-xl my-12 relative overflow-hidden">
            ...
            <div id="faq" className="mt-16 pt-10 border-t border-slate-100 text-left">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-slate-50 p-8 rounded-3xl border border-green-100">
                  ...
                  <p className="text-slate-600 m-0 leading-relaxed">Não. Para quem busca precisão clínica e isolamento de oscilações hídricas, a <Link to="/o_que_e_antropometria" className="text-green-700 hover:text-green-700 underline underline-offset-2 font-bold transition-colors">antropometria (ISAK)</Link> é muito mais consistente, sendo o padrão-ouro acessível para medir a gordura subcutânea real.</p>
                </div>
                <div className="bg-slate-50 p-8 rounded-3xl border border-green-100">
