...
const probioticosDados = [
  ...
  { id: 9, nome: "Picles (Salmoura)", tipo: "Bactérias Lácticas", descricao: "Pepinos fermentados em água e sal (não vinagre) são fontes maravilhosas.", Icone: CheckCircle2, corIcone: "text-green-700" },
        ...
        <article className="prose prose-lg max-w-none text-left">
            ...
            <nav className="bg-slate-50">
              ...
              <div className={`transition-all duration-500 ease-in-out ${isTocOpen ? 'max-h-[1000px] opacity-100 border-t border-green-100/60' : 'max-h-0 opacity-0'} overflow-hidden bg-white`}>
                <ul className="p-5 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 list-none m-0">
                  <li><a href="#fisiologia" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Zap size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />A Ciência das Bactérias</a></li>
                  ...
                  <li><a href="#recomendacoes" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><FileText size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Doses e Suplementação</a></li>
                  <li><a href="#video" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><PlayCircle size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Vídeo: Pre vs Probióticos</a></li>
                  <li><a href="#lista-probioticos" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Beaker size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Lista Completa</a></li>
          ...
          <div className="space-y-6 text-lg text-slate-600 font-medium leading-relaxed">
            ...
            <h2 id="fisiologia" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Zap className="text-green-700"/> A Ciência: Como as bactérias boas agem no corpo?
            </h2>
            <p>
            ...
            <h2 id="beneficios" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Shield className="text-green-700"/> Lactobacillus para que serve? Os Benefícios Reais
            </h2>
            <p>
            ...
            <p className="bg-slate-100 p-6 rounded-2xl border border-slate-200 text-slate-700 italic mt-6">
              Além disso, o processo de fermentação gerado por essas bactérias ajuda significativamente na quebra da lactose, aliviando os sintomas em pessoas intolerantes, assim como exploramos ao explicar <Link to="/por_que_o_feijao_da_gases" className="text-green-700 font-semibold hover:underline">por que o feijão dá gases</Link> e como a digestão enzimática pode ser facilitada quando a microbiota está saudável e operante.
            </p>
            ...
            <h2 id="recomendacoes" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <FileText className="text-green-700"/> Doses e Suplementação: Como tomar certo?
            </h2>
            <p>
            ...
            <div id="lista-probioticos" className="my-16 bg-slate-50 py-12 px-4 md:px-8 rounded-[3rem] border border-slate-200 shadow-inner">
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-4xl font-black text-slate-900 uppercase italic tracking-tight mb-6">
                  A Lista Definitiva de <span className="text-green-700">Probióticos</span>
                </h2>
            ...
            <div id="faq" className="mt-16 pt-10 border-t border-slate-100 text-left">
              <h2 className="text-2xl font-black text-slate-800 mb-8 flex items-center gap-3 italic">
                <HelpCircle className="text-green-700" /> Perguntas Frequentes sobre Probióticos
              </h2>
