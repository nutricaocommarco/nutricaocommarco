              ...
              <nav className="bg-slate-50">
                ...
                <div className={`transition-all duration-500 ease-in-out ${isTocOpen ? 'max-h-[1000px] opacity-100 border-t border-green-100/60' : 'max-h-0 opacity-0'} overflow-hidden bg-white`}>
                  <ul className="p-5 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 list-none m-0">
                    <li><a href="#introducao" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Brain size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />O que ela faz no corpo</a></li>
                    <li><a href="#efeitos-colaterais" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><AlertCircle size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Quais são os Riscos?</a></li>
                    <li><a href="#dependencia" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Shield size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Dependência Psicológica</a></li>
                    <li><a href="#contraindicacoes" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Zap size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Quem NÃO deve tomar</a></li>
                    <li><a href="#indicacoes" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><FileText size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Indicações Corretas</a></li>
                    <li><a href="#dose" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Clock size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />A Dose Certa</a></li>
                    ...
                    <li><a href="#dormir-naturalmente" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Moon size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Dormir Naturalmente</a></li>
                    <li><a href="#estudos" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><BookOpen size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Tabela de Estudos</a></li>
                  </ul>
                </div>
              </nav>
            </div>
...
<figure className="my-12 rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl border border-slate-100 group flex flex-col bg-slate-200">
            ...
            <figcaption className="bg-slate-50 p-4 md:p-6 text-center border-t border-slate-200 relative z-10">
              ...
              <h2 id="indicacoes" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
                <FileText className="text-green-700"/> Para quem a Melatonina é indicada?
              </h2>
              <p>
              ...
              <h2 id="dose" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
                <Clock className="text-green-700"/> A Dose Certa: Tomar muito diminui a produção natural?
              </h2>
              <p>
              ...
              <div className="my-14 bg-slate-50 p-6 md:p-10 rounded-[3rem] border border-slate-200 shadow-inner">
                <div className="text-center mb-10">
                  <h3 className="text-2xl md:text-3xl font-black text-slate-900 uppercase italic tracking-tight m-0">
                    O que <span className="text-red-500">Destrói</span> vs O que <span className="text-green-700">Estimula</span>
                  </h3>
                  ...
                  {tabelaEstimulantes.map((fator) => (
                    <div key={fator.id} className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden flex flex-col lg:flex-row">
                      ...
                      <div className="flex-1 p-5 md:p-6 bg-green-50/50 border-b lg:border-b-0 lg:border-r border-slate-100 flex flex-col gap-3">
                        <div className="flex items-center gap-2 text-green-700 font-black uppercase text-[11px] tracking-widest">
              ...
              <h2 id="dormir-naturalmente" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
                <Moon className="text-green-700"/> Como dormir rápido sem depender de suplementos
              </h2>
              <p>
              ...
              <div id="estudos" className="my-16 bg-slate-50 py-12 px-4 md:px-8 rounded-[3rem] border border-slate-200 shadow-inner">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-2xl md:text-3xl font-black text-slate-900 uppercase italic tracking-tight mb-4 flex justify-center items-center gap-3">
                    <Database className="text-green-700" /> Tabela de Referências e Estudos
                  </h2>
                ...
                <div className="bg-white rounded-[2rem] border border-slate-200 shadow-lg overflow-hidden">
                  <div className="hidden md:grid grid-cols-4 bg-green-700 text-white font-black uppercase tracking-widest text-[11px] p-4">
                  ...
                  {referenciasCientificas.map((ref, idx) => (
                    <div key={ref.id} className={`grid grid-cols-1 md:grid-cols-4 gap-4 p-5 md:p-4 items-center border-b border-slate-100 last:border-0 hover:bg-green-50 transition-colors ${idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'}`}>
                      <div className="font-bold text-slate-800 text-sm md:text-base"><span className="md:hidden text-green-700 font-black uppercase text-xs block mb-1">Foco</span>{ref.tema}</div>
                      ...
                      <div className="col-span-2 flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
                        ...
                        <a href={ref.link} target="_blank" rel="noopener noreferrer" className="shrink-0 bg-slate-800 text-white px-4 py-2 rounded-full text-xs font-bold hover:bg-green-700 transition-colors flex items-center gap-1">
              ...
              <div id="faq" className="mt-16 pt-10 border-t border-slate-100 text-left">
                <h2 className="text-2xl font-black text-slate-800 mb-8 flex items-center gap-3 italic">
                  <HelpCircle className="text-green-700" /> Perguntas Frequentes sobre Melatonina
                </h2>
