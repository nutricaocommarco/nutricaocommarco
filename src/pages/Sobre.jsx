    ...
    <section className="py-24 bg-slate-50 px-6 container mx-auto max-w-5xl text-left">
      <div className="bg-white p-8 md:p-16 rounded-[4rem] shadow-2xl border border-slate-100 flex flex-col md:flex-row gap-12 items-center">
        ...
        <article className="prose prose-lg max-w-none text-left w-full md:w-3/5">
          <span className="inline-block bg-green-50 text-green-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest mb-6">Fisiologia • Antropometria • Endurance</span>

          <h1 className="text-4xl md:text-5xl font-black mb-10 uppercase italic leading-tight text-slate-900">
            Marco Aurélio Jr: Onde a <span className="text-green-700">Experiência Prática</span> encontra a <span className="text-green-700">Ciência da Nutrição</span>
          </h1>
          ...
          <Microscope className="text-green-700"/> Precisão e Metabolismo: ISAK 1 e Pós-Graduação
            ...
            <h2 className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Camera className="text-green-700"/> Fotografia, Ciclismo e Endurance
            </h2>
            ...
            <p className="font-bold text-xl text-slate-900 mt-12 flex items-center gap-3">
              <MapPin className="text-green-700"/> Atuando com Ciência no Pechincha e no Rio de Janeiro.
            </p>
          </div>
        </article>
      </div>
