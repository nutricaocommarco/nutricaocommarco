  ...
  return (
    <section className="py-24 bg-slate-50 px-6 container mx-auto max-w-6xl text-left">
      ...
      <div className="space-y-24">
        <div>
          <h2 className="text-2xl font-black text-slate-800 uppercase italic mb-10 flex items-center gap-4 justify-center md:justify-start"><span className="w-12 h-1 bg-green-700 rounded-full"></span> Formação Principal</h2>
        ...
        <div>
          <h2 className="text-2xl font-black text-slate-800 uppercase italic mb-10 flex items-center gap-4 justify-center md:justify-start"><span className="w-12 h-1 bg-green-700 rounded-full"></span> Prática Clínica e Comportamental</h2>
      ...
      <Link to="/" className="mx-auto mt-20 flex items-center gap-2 font-black uppercase text-slate-400 hover:text-green-700 transition-colors w-fit">Voltar ao Início <ArrowUpRight size={20} /></Link>
    </section>
  );
}
  ...
  return (
    <div className="bg-white rounded-[2.5rem] shadow-md border border-slate-50 hover:shadow-xl hover:-translate-y-1 transition-all overflow-hidden flex flex-col min-h-[380px] text-left">
      ...
      <div className="p-8 flex flex-col flex-grow text-left">
        ...
        <p className="text-green-700 font-black text-[10px] uppercase mb-4">{org}</p>
