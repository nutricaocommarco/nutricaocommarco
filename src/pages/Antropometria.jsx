      ...
      <div className="bg-white p-8 md:p-16 rounded-[4rem] shadow-2xl border border-slate-100">
        ...
        <article className="prose prose-lg max-w-none">
          ...
          <div className="space-y-6 text-lg text-slate-600 font-medium leading-relaxed text-left">
            ...
            <p>Diferente do que muitos acreditam, a avaliação física vai muito além de uma simples pesagem na balança comum (aliás, se já se perguntou se <Link to="/a_balanca_de_bioimpedancia_e_confiavel" className="text-green-600 hover:text-green-700 underline underline-offset-2 font-bold transition-colors">a balança de bioimpedância é confiável</Link>, vale a leitura deste artigo). A antropometria oferece uma análise profunda do que o seu peso total realmente representa, separando os tecidos para uma intervenção nutricional verdadeiramente personalizada.</p>
