...
const foodDatabase = [
  ...
  { id: 21, name: "Cereais, milho, flocos, com sal", carbs: 80.8 },
  { id: 22, name: "Cereais, milho, flocos, sem sal", carbs: 80.4 },
  { id: 23, name: "Cereais, mingau, milho, infantil", carbs: 87.3 },
  { id: 24, name: "Cereais, mistura para vitamina, trigo, cevada e aveia", carbs: 81.6 },
  { id: 25, name: "Cereal matinal, milho", carbs: 83.8 },
  { id: 26, name: "Cereal matinal, milho, com açúcar", carbs: 88.8 },
  { id: 27, name: "Creme de arroz, pó", carbs: 83.9 },
  { id: 28, name: "Creme de milho, pó", carbs: 86.1 },
  { id: 29, name: "Curau, milho verde", carbs: 13.9 },
  { id: 30, name: "Curau, milho verde, mistura para", carbs: 79.8 },
  { id: 31, name: "Farinha, de arroz, enriquecida", carbs: 85.5 },
  { id: 32, name: "Farinha, de centeio, integral", carbs: 73.3 },
  { id: 33, name: "Farinha, de milho, amarela", carbs: 79.1 },
  { id: 34, name: "Farinha, de rosca", carbs: 75.8 },
  { id: 35, name: "Farinha, de trigo", carbs: 75.1 },
  { id: 36, name: "Farinha, láctea, de cereais", carbs: 77.8 },
  { id: 37, name: "Lasanha, massa fresca, cozida", carbs: 32.5 },
  { id: 38, name: "Lasanha, massa fresca, crua", carbs: 45.1 },
  { id: 39, name: "Macarrão, instantâneo", carbs: 62.4 },
  { id: 40, name: "Macarrão, trigo, cru", carbs: 77.9 },
  { id: 41, name: "Macarrão, trigo, cru, com ovos", carbs: 76.6 },
  { id: 42, name: "Milho, amido, cru", carbs: 87.1 },
  { id: 43, name: "Milho, fubá, cru", carbs: 78.9 },
  { id: 44, name: "Milho, verde, cru", carbs: 28.6 },
  { id: 45, name: "Milho, verde, enlatado, drenado", carbs: 17.1 },
  { id: 46, name: "Mingau tradicional, pó", carbs: 89.3 },
  { id: 47, name: "Pamonha, barra para cozimento, pré-cozida", carbs: 30.7 },
  { id: 48, name: "Pão, aveia, forma", carbs: 59.6 },
  { id: 49, name: "Pão, de soja", carbs: 56.5 },
  { id: 50, name: "Pão, glúten, forma", carbs: 44.1 },
  { id: 51, name: "Pão, milho, forma", carbs: 56.4 },
  { id: 52, name: "Pão, trigo, forma, integral", carbs: 49.9 },
  { id: 53, name: "Pão, trigo, francês", carbs: 58.6 },
  { id: 54, name: "Pão, trigo, sovado", carbs: 61.5 },
  { id: 55, name: "Pastel, de carne, cru", carbs: 42.0 },
  { id: 56, name: "Pastel, de carne, frito", carbs: 43.8 },
  { id: 57, name: "Pastel, de queijo, cru", carbs: 45.9 },
  { id: 58, name: "Pastel, de queijo, frito", carbs: 48.1 },
  { id: 59, name: "Pastel, massa, crua", carbs: 57.4 },
  { id: 60, name: "Pastel, massa, frita", carbs: 49.3 },
  { id: 61, name: "Pipoca, com óleo de soja, sem sal", carbs: 70.3 },
  { id: 62, name: "Polenta, pré-cozida", carbs: 23.3 },
  { id: 63, name: "Torrada, pão francês", carbs: 74.6 },
  { id: 64, name: "Abóbora, cabotian, cozida", carbs: 10.8 },
  { id: 65, name: "Abóbora, cabotian, crua", carbs: 8.4 },
  { id: 66, name: "Abóbora, menina brasileira, crua", carbs: 3.3 },
  { id: 67, name: "Abóbora, moranga, crua", carbs: 2.7 },
  { id: 68, name: "Abóbora, moranga, refogada", carbs: 6.0 },
  { id: 69, name: "Abóbora, pescoço, crua", carbs: 6.1 },
  { id: 70, name: "Alface, americana, crua", carbs: 1.7 },
  { id: 71, name: "Alface, crespa, crua", carbs: 1.7 },
  { id: 72, name: "Alface, lisa, crua", carbs: 2.4 },
  { id: 73, name: "Alface, roxa, crua", carbs: 2.5 },
  { id: 74, name: "Alho, cru", carbs: 23.9 },
  { id: 75, name: "Alho-poró, cru", carbs: 6.9 },
  { id: 76, name: "Batata, baroa, cozida", carbs: 18.9 },
  { id: 77, name: "Batata, baroa, crua", carbs: 24.0 },
  { id: 78, name: "Batata, doce, cozida", carbs: 18.4 },
  { id: 79, name: "Batata, doce, crua", carbs: 28.2 },
  { id: 80, name: "Batata, frita, tipo chips, industrializada", carbs: 51.2 },
  { id: 81, name: "Batata, inglesa, cozida", carbs: 11.9 },
  { id: 82, name: "Batata, inglesa, crua", carbs: 14.7 },
  { id: 83, name: "Batata, inglesa, frita", carbs: 35.6 },
  { id: 84, name: "Batata, inglesa, sauté", carbs: 14.1 },
  { id: 85, name: "Biscoito, polvilho doce", carbs: 80.5 },
  { id: 86, name: "Brócolis, cozido", carbs: 4.4 },
  { id: 87, name: "Brócolis, cru", carbs: 4.0 },
  { id: 88, name: "Cará, cozido", carbs: 18.9 },
  { id: 89, name: "Cará, cru", carbs: 23.0 },
  { id: 90, name: "Cebola, crua", carbs: 8.9 },
  { id: 91, name: "Cenoura, cozida", carbs: 6.7 },
  { id: 92, name: "Cenoura, crua", carbs: 7.7 },
  { id: 93, name: "Coentro, folhas desidratadas", carbs: 48.0 },
  { id: 94, name: "Couve, manteiga, crua", carbs: 4.3 },
  { id: 95, name: "Couve, manteiga, refogada", carbs: 8.7 },
  { id: 96, name: "Couve-flor, crua", carbs: 4.5 },
  { id: 97, name: "Couve-flor, cozida", carbs: 3.9 },
  { id: 98, name: "Farinha, de mandioca, crua", carbs: 87.9 },
  { id: 99, name: "Farinha, de mandioca, torrada", carbs: 89.2 },
  { id: 100, name: "Farinha, de puba", carbs: 87.3 },
  { id: 101, name: "Fécula, de mandioca", carbs: 81.1 },
  { id: 102, name: "Feijão, broto, cru", carbs: 7.8 },
  { id: 103, name: "Inhame, cru", carbs: 23.2 },
  { id: 104, name: "Jurubeba, crua", carbs: 23.1 },
  { id: 105, name: "Mandioca, cozida", carbs: 30.1 },
  { id: 106, name: "Mandioca, crua", carbs: 36.2 },
  { id: 107, name: "Mandioca, farofa, temperada", carbs: 80.3 },
  { id: 108, name: "Mandioca, frita", carbs: 50.3 },
  { id: 109, name: "Nhoque, batata, cozido", carbs: 36.8 },
  { id: 110, name: "Pão, de queijo, assado", carbs: 34.2 },
  { id: 111, name: "Pão, de queijo, cru", carbs: 38.5 },
  { id: 112, name: "Polvilho, doce", carbs: 86.8 },
  { id: 113, name: "Seleta de legumes, enlatada", carbs: 12.7 },
  { id: 114, name: "Tomate, com semente, cru", carbs: 3.1 },
  { id: 115, name: "Tomate, extrato", carbs: 15.0 },
  { id: 116, name: "Tomate, molho industrializado", carbs: 7.7 },
  { id: 117, name: "Tomate, purê", carbs: 6.9 },
  { id: 118, name: "Tomate, salada", carbs: 5.1 },
  { id: 119, name: "Abacaxi, cru", carbs: 12.3 },
  { id: 120, name: "Abiu, cru", carbs: 14.9 },
  { id: 121, name: "Açaí, polpa, com xarope de guaraná e glucose", carbs: 21.5 },
  { id: 122, name: "Ameixa, calda, enlatada", carbs: 46.9 },
  { id: 123, name: "Ameixa, crua", carbs: 13.9 },
  { id: 124, name: "Ameixa, em calda, enlatada, drenada", carbs: 47.7 },
  { id: 125, name: "Atemóia, crua", carbs: 25.3 },
  { id: 126, name: "Banana, da terra, crua", carbs: 33.7 },
  { id: 127, name: "Banana, doce em barra", carbs: 75.7 },
  { id: 128, name: "Banana, figo, crua", carbs: 27.8 },
  { id: 129, name: "Banana, maçã, crua", carbs: 22.3 },
  { id: 130, name: "Banana, nanica, crua", carbs: 23.8 },
  { id: 131, name: "Banana, ouro, crua", carbs: 29.3 },
  { id: 132, name: "Banana, pacova, crua", carbs: 20.3 },
  { id: 133, name: "Banana, prata, crua", carbs: 26.0 },
  { id: 134, name: "Cacau, cru", carbs: 19.4 },
  { id: 135, name: "Caju, suco concentrado, envasado", carbs: 10.7 },
  { id: 136, name: "Caqui, chocolate, cru", carbs: 19.3 },
  { id: 137, name: "Ciriguela, crua", carbs: 18.9 },
  { id: 138, name: "Figo, enlatado, em calda", carbs: 50.3 },
  { id: 139, name: "Fruta-pão, crua", carbs: 17.2 },
  { id: 140, name: "Goiaba, branca, com casca, crua", carbs: 12.4 },
  { id: 141, name: "Goiaba, doce em pasta", carbs: 74.1 },
  { id: 142, name: "Goiaba, doce, cascão", carbs: 78.7 },
  { id: 143, name: "Goiaba, vermelha, com casca, crua", carbs: 13.0 },
  { id: 144, name: "Graviola, crua", carbs: 15.8 },
  { id: 145, name: "Jabuticaba, crua", carbs: 15.3 },
  { id: 146, name: "Jaca, crua", carbs: 22.5 },
  { id: 147, name: "Laranja, baía, crua", carbs: 11.5 },
  { id: 148, name: "Laranja, baía, suco", carbs: 8.7 },
  { id: 149, name: "Laranja, da terra, crua", carbs: 12.9 },
  { id: 150, name: "Laranja, da terra, suco", carbs: 9.6 },
  { id: 151, name: "Laranja, lima, crua", carbs: 11.5 },
  { id: 152, name: "Laranja, lima, suco", carbs: 9.2 },
  { id: 153, name: "Laranja, pêra, crua", carbs: 8.9 },
  { id: 154, name: "Laranja, pêra, suco", carbs: 7.6 },
  { id: 155, name: "Laranja, valência, crua", carbs: 11.7 },
  { id: 156, name: "Laranja, valência, suco", carbs: 8.6 },
  { id: 157, name: "Limão, cravo, suco", carbs: 5.2 },
  { id: 158, name: "Limão, galego, suco", carbs: 7.3 },
  { id: 159, name: "Maçã, Argentina, com casca, crua", carbs: 16.6 },
  { id: 160, name: "Maçã, Fuji, com casca, crua", carbs: 15.2 },
  { id: 161, name: "Macaúba, crua", carbs: 13.9 },
  { id: 162, name: "Mamão, doce em calda, drenado", carbs: 54.0 },
  { id: 163, name: "Mamão verde, doce em calda, drenado", carbs: 57.6 },
  { id: 164, name: "Manga, Haden, crua", carbs: 16.7 },
  { id: 165, name: "Manga, Palmer, crua", carbs: 19.4 },
  { id: 166, name: "Manga, polpa, congelada", carbs: 12.5 },
  { id: 167, name: "Manga, Tommy Atkins, crua", carbs: 12.8 },
  { id: 168, name: "Maracujá, suco concentrado, envasado", carbs: 9.6 },
  { id: 169, name: "Melancia, crua", carbs: 8.1 },
  { id: 170, name: "Mexerica, Murcote, crua", carbs: 14.9 },
  { id: 171, name: "Pequi, cru", carbs: 13.0 },
  { id: 172, name: "Pêra, Park, crua", carbs: 16.1 },
  { id: 173, name: "Pêra, Williams, crua", carbs: 14.0 },
  { id: 174, name: "Pêssego, enlatado, em calda", carbs: 16.9 },
  { id: 175, name: "Pinha, crua", carbs: 22.4 },
  { id: 176, name: "Romã, crua", carbs: 15.1 },
  { id: 177, name: "Tamarindo, cru", carbs: 72.5 },
  { id: 178, name: "Tangerina, Poncã, suco", carbs: 8.8 },
  { id: 179, name: "Tucumã, cru", carbs: 26.5 },
  { id: 180, name: "Uva, Itália, crua", carbs: 13.6 },
  { id: 181, name: "Uva, Rubi, crua", carbs: 12.7 },
  { id: 182, name: "Uva, suco concentrado, envasado", carbs: 14.7 },
  { id: 183, name: "Manteiga, com sal", carbs: 0.1 },
  { id: 184, name: "Manteiga, sem sal", carbs: 0.0 },
  { id: 185, name: "Caldo de carne, tablete", carbs: 15.1 },
  { id: 186, name: "Carne, bovina, acém, moído, cozido", carbs: 0.0 },
  { id: 187, name: "Carne, bovina, acém, moído, cru", carbs: 0.0 },
  { id: 188, name: "Carne, bovina, acém, sem gordura, cozido", carbs: 0.0 },
  { id: 189, name: "Carne, bovina, acém, sem gordura, cru", carbs: 0.0 },
  { id: 190, name: "Carne, bovina, almôndegas, cruas", carbs: 9.8 },
  { id: 191, name: "Carne, bovina, almôndegas, fritas", carbs: 14.3 },
  { id: 192, name: "Carne, bovina, bucho, cozido", carbs: 0.0 },
  { id: 193, name: "Carne, bovina, bucho, cru", carbs: 0.0 },
  { id: 194, name: "Carne, bovina, capa de contra-filé, com gordura, crua", carbs: 0.0 },
  { id: 195, name: "Carne, bovina, capa de contra-filé, com gordura, grelhada", carbs: 0.0 },
  { id: 196, name: "Carne, bovina, capa de contra-filé, sem gordura, crua", carbs: 0.0 },
  { id: 197, name: "Carne, bovina, capa de contra-filé, sem gordura, grelhada", carbs: 0.0 },
  { id: 198, name: "Carne, bovina, charque, cozido", carbs: 0.0 },
  { id: 199, name: "Carne, bovina, charque, cru", carbs: 0.0 },
  { id: 200, name: "Carne, bovina, contra-filé, à milanesa", carbs: 12.2 },
  { id: 201, name: "Carne, bovina, contra-filé de costela, cru", carbs: 0.0 },
  { id: 202, name: "Carne, bovina, contra-filé de costela, grelhado", carbs: 0.0 },
  { id: 203, name: "Carne, bovina, contra-filé, com gordura, cru", carbs: 0.0 },
  { id: 204, name: "Carne, bovina, contra-filé, com gordura, grelhado", carbs: 0.0 },
  { id: 205, name: "Carne, bovina, contra-filé, sem gordura, cru", carbs: 0.0 },
  { id: 206, name: "Carne, bovina, contra-filé, sem gordura, grelhado", carbs: 0.0 },
  { id: 207, name: "Carne, bovina, costela, assada", carbs: 0.0 },
  { id: 208, name: "Carne, bovina, costela, crua", carbs: 0.0 },
  { id: 209, name: "Carne, bovina, coxão duro, sem gordura, cozido", carbs: 0.0 },
  { id: 210, name: "Carne, bovina, coxão duro, sem gordura, cru", carbs: 0.0 },
  { id: 211, name: "Carne, bovina, coxão mole, sem gordura, cozido", carbs: 0.0 },
  { id: 212, name: "Carne, bovina, coxão mole, sem gordura, cru", carbs: 0.0 },
  { id: 213, name: "Carne, bovina, cupim, assado", carbs: 0.0 },
  { id: 214, name: "Carne, bovina, cupim, cru", carbs: 0.0 },
  { id: 215, name: "Carne, bovina, fígado, cru", carbs: 1.1 },
  { id: 216, name: "Carne, bovina, fígado, grelhado", carbs: 4.2 },
  { id: 217, name: "Carne, bovina, filé mingnon, sem gordura, cru", carbs: 0.0 },
  { id: 218, name: "Carne, bovina, filé mingnon, sem gordura, grelhado", carbs: 0.0 },
  { id: 219, name: "Carne, bovina, flanco, sem gordura, cozido", carbs: 0.0 },
  { id: 220, name: "Carne, bovina, flanco, sem gordura, cru", carbs: 0.0 },
  { id: 221, name: "Carne, bovina, fraldinha, com gordura, cozida", carbs: 0.0 },
  { id: 222, name: "Carne, bovina, fraldinha, com gordura, crua", carbs: 0.0 },
  { id: 223, name: "Carne, bovina, lagarto, cozido", carbs: 0.0 },
  { id: 224, name: "Carne, bovina, lagarto, cru", carbs: 0.0 },
  { id: 225, name: "Carne, bovina, língua, cozida", carbs: 0.0 },
  { id: 226, name: "Carne, bovina, língua, crua", carbs: 0.0 },
  { id: 227, name: "Carne, bovina, maminha, crua", carbs: 0.0 },
  { id: 228, name: "Carne, bovina, maminha, grelhada", carbs: 0.0 },
  { id: 229, name: "Carne, bovina, miolo de alcatra, sem gordura, cru", carbs: 0.0 },
  { id: 230, name: "Carne, bovina, miolo de alcatra, sem gordura, grelhado", carbs: 0.0 },
  { id: 231, name: "Carne, bovina, músculo, sem gordura, cozido", carbs: 0.0 },
  { id: 232, name: "Carne, bovina, músculo, sem gordura, cru", carbs: 0.0 },
  { id: 233, name: "Carne, bovina, paleta, com gordura, crua", carbs: 0.0 },
  { id: 234, name: "Carne, bovina, paleta, sem gordura, cozida", carbs: 0.0 },
  { id: 235, name: "Carne, bovina, paleta, sem gordura, crua", carbs: 0.0 },
  { id: 236, name: "Carne, bovina, patinho, sem gordura, cru", carbs: 0.0 },
  { id: 237, name: "Carne, bovina, patinho, sem gordura, grelhado", carbs: 0.0 },
  { id: 238, name: "Carne, bovina, peito, sem gordura, cozido", carbs: 0.0 },
  { id: 239, name: "Carne, bovina, peito, sem gordura, cru", carbs: 0.0 },
  { id: 240, name: "Carne, bovina, picanha, com gordura, crua", carbs: 0.0 },
  { id: 241, name: "Carne, bovina, picanha, com gordura, grelhada", carbs: 0.0 },
  { id: 242, name: "Carne, bovina, picanha, sem gordura, crua", carbs: 0.0 },
  { id: 243, name: "Carne, bovina, picanha, sem gordura, grelhada", carbs: 0.0 },
  { id: 244, name: "Carne, bovina, seca, cozida", carbs: 0.0 },
  { id: 245, name: "Carne, bovina, seca, crua", carbs: 0.0 },
  { id: 246, name: "Coxinha de frango, frita", carbs: 34.5 },
  { id: 247, name: "Croquete, de carne, cru", carbs: 13.9 },
  { id: 248, name: "Croquete, de carne, frito", carbs: 18.1 },
  { id: 249, name: "Empada de frango, pré-cozida, assada", carbs: 47.5 },
  { id: 250, name: "Empada, de frango, pré-cozida", carbs: 35.5 },
  { id: 251, name: "Frango, asa, com pele, crua", carbs: 0.0 },
  { id: 252, name: "Frango, caipira, inteiro, com pele, cozido", carbs: 0.0 },
  { id: 253, name: "Frango, caipira, inteiro, sem pele, cozido", carbs: 0.0 },
  { id: 254, name: "Frango, coração, cru", carbs: 0.0 },
  { id: 255, name: "Frango, coração, grelhado", carbs: 0.6 },
  { id: 256, name: "Frango, coxa, com pele, assada", carbs: 0.1 },
  { id: 257, name: "Frango, coxa, com pele, crua", carbs: 0.0 },
  { id: 258, name: "Frango, coxa, sem pele, cozida", carbs: 0.0 },
  { id: 259, name: "Frango, coxa, sem pele, crua", carbs: 0.0 },
  { id: 260, name: "Frango, fígado, cru", carbs: 0.0 },
  { id: 261, name: "Frango, filé, à milanesa", carbs: 7.5 },
  { id: 262, name: "Frango, inteiro, com pele, cru", carbs: 0.0 },
  { id: 263, name: "Frango, inteiro, sem pele, assado", carbs: 0.0 },
  { id: 264, name: "Frango, inteiro, sem pele, cozido", carbs: 0.0 },
  { id: 265, name: "Frango, inteiro, sem pele, cru", carbs: 0.0 },
  { id: 266, name: "Frango, peito, com pele, assado", carbs: 0.0 },
  { id: 267, name: "Frango, peito, com pele, cru", carbs: 0.0 },
  { id: 268, name: "Frango, peito, sem pele, cozido", carbs: 0.0 },
  { id: 269, name: "Frango, peito, sem pele, cru", carbs: 0.0 },
  { id: 270, name: "Frango, peito, sem pele, grelhado", carbs: 0.0 },
  { id: 271, name: "Frango, sobrecoxa, com pele, assada", carbs: 0.0 },
  { id: 272, name: "Frango, sobrecoxa, com pele, crua", carbs: 0.0 },
  { id: 273, name: "Frango, sobrecoxa, sem pele, assada", carbs: 0.0 },
  { id: 274, name: "Frango, sobrecoxa, sem pele, crua", carbs: 0.0 },
  { id: 275, name: "Lingüiça, frango, crua", carbs: 0.0 },
  { id: 276, name: "Lingüiça, frango, frita", carbs: 0.0 },
  { id: 277, name: "Lingüiça, frango, grelhada", carbs: 0.0 },
  { id: 278, name: "Lingüiça, porco, crua", carbs: 0.0 },
  { id: 279, name: "Lingüiça, porco, frita", carbs: 0.0 },
  { id: 280, name: "Lingüiça, porco, grelhada", carbs: 0.0 },
  { id: 281, name: "Porco, bisteca, crua", carbs: 0.0 },
  { id: 282, name: "Porco, bisteca, frita", carbs: 0.0 },
  { id: 283, name: "Porco, bisteca, grelhada", carbs: 0.0 },
  { id: 284, name: "Porco, costela, assada", carbs: 0.0 },
  { id: 285, name: "Porco, costela, crua", carbs: 0.0 },
  { id: 286, name: "Porco, lombo, assado", carbs: 0.0 },
  { id: 287, name: "Porco, lombo, cru", carbs: 0.0 },
  { id: 288, name: "Porco, orelha, salgada, crua", carbs: 0.0 },
  { id: 289, name: "Porco, pernil, assado", carbs: 0.0 },
  { id: 290, name: "Porco, pernil, cru", carbs: 0.0 },
  { id: 291, name: "Porco, rabo, salgado, cru", carbs: 0.0 },
  { id: 292, name: "Quibe, assado", carbs: 12.9 },
  { id: 293, name: "Quibe, frito", carbs: 12.3 },
  { id: 294, name: "Creme de Leite", carbs: 4.5 },
  { id: 295, name: "Leite, condensado", carbs: 57.0 },
  { id: 296, name: "Leite, de cabra", carbs: 5.2 },
  { id: 297, name: "Leite, de vaca, achocolatado", carbs: 14.2 },
  { id: 298, name: "Leite, de vaca, desnatado, pó", carbs: 53.0 },
  { id: 299, name: "Leite, de vaca, desnatado, UHT", carbs: 0.0 },
  { id: 300, name: "Leite, de vaca, integral", carbs: 0.0 },
  { id: 301, name: "Leite, de vaca, integral, pó", carbs: 39.2 },
  { id: 302, name: "Leite, fermentado", carbs: 15.7 },
  { id: 303, name: "Queijo, minas, frescal", carbs: 3.2 },
  { id: 304, name: "Queijo, minas, meia cura", carbs: 3.6 },
  { id: 305, name: "Queijo, mozarela", carbs: 3.0 },
  { id: 306, name: "Queijo, parmesão", carbs: 1.7 },
  { id: 307, name: "Queijo, pasteurizado", carbs: 5.7 },
  { id: 308, name: "Queijo, petit suisse, morango", carbs: 18.5 },
  { id: 309, name: "Queijo, prato", carbs: 1.9 },
  { id: 310, name: "Queijo, requeijão, cremoso", carbs: 2.4 },
  { id: 311, name: "Queijo, ricota", carbs: 3.8 },
  { id: 312, name: "Cana, caldo de", carbs: 18.2 },
  { id: 313, name: "Refrigerante, tipo laranja", carbs: 11.8 },
  { id: 314, name: "Omelete, de queijo", carbs: 0.4 },
  { id: 315, name: "Ovo, de codorna, inteiro, cru", carbs: 0.8 },
  { id: 316, name: "Ovo, de galinha, clara, cozida", carbs: 0.0 },
  { id: 317, name: "Ovo, de galinha, gema, cozida", carbs: 1.6 },
  { id: 318, name: "Ovo, de galinha, inteiro, cozido", carbs: 0.6 },
  { id: 319, name: "Ovo, de galinha, inteiro, cru", carbs: 1.6 },
  { id: 320, name: "Ovo, de galinha, inteiro, frito", carbs: 1.2 },
  { id: 321, name: "Achocolatado, pó", carbs: 91.2 },
  { id: 322, name: "Açúcar, cristal", carbs: 99.6 },
  { id: 323, name: "Açúcar, mascavo", carbs: 94.5 },
  { id: 324, name: "Açúcar, refinado", carbs: 99.5 },
  { id: 325, name: "Chocolate, ao leite", carbs: 59.6 },
  { id: 326, name: "Chocolate, ao leite, com castanha do Pará", carbs: 55.4 },
  { id: 327, name: "Chocolate, ao leite, dietético", carbs: 56.3 },
  { id: 328, name: "Chocolate, meio amargo", carbs: 62.4 },
  { id: 329, name: "Cocada branca", carbs: 81.4 },
  { id: 330, name: "Doce, de abóbora, cremoso", carbs: 54.6 },
  { id: 331, name: "Doce, de leite, cremoso", carbs: 59.5 },
  { id: 332, name: "Geléia, mocotó, natural", carbs: 24.2 },
  { id: 333, name: "Glicose de milho", carbs: 79.4 },
  { id: 334, name: "Maria mole", carbs: 73.6 },
  { id: 335, name: "Maria mole, coco queimado", carbs: 75.1 },
  { id: 336, name: "Marmelada", carbs: 70.8 },
  { id: 337, name: "Mel, de abelha", carbs: 84.0 },
  { id: 338, name: "Melado", carbs: 76.6 },
  { id: 339, name: "Quindim", carbs: 46.3 },
  { id: 340, name: "Rapadura", carbs: 90.8 },
  { id: 341, name: "Café, pó, torrado", carbs: 65.8 },
  { id: 342, name: "Capuccino, pó", carbs: 73.6 },
  { id: 343, name: "Fermento em pó, químico", carbs: 43.9 },
  { id: 344, name: "Gelatina, sabores variados, pó", carbs: 89.2 },
  { id: 345, name: "Chantilly, spray, com gordura vegetal", carbs: 16.9 },
  { id: 346, name: "Leite, de coco", carbs: 2.2 },
  { id: 347, name: "Maionese, tradicional com ovos", carbs: 7.9 },
  { id: 348, name: "Acarajé", carbs: 19.1 },
  { id: 349, name: "Arroz carreteiro", carbs: 11.6 },
  { id: 350, name: "Baião de dois, arroz e feijão-de-corda", carbs: 20.4 },
  { id: 351, name: "Bolinho de arroz", carbs: 41.7 },
  { id: 352, name: "Cuscuz, de milho, cozido com sal", carbs: 25.3 },
  { id: 353, name: "Cuscuz, paulista", carbs: 22.5 },
  { id: 354, name: "Estrogonofe de carne", carbs: 3.0 },
  { id: 355, name: "Estrogonofe de frango", carbs: 2.6 },
  { id: 356, name: "Feijão tropeiro mineiro", carbs: 19.6 },
  { id: 357, name: "Frango, com açafrão", carbs: 4.1 },
  { id: 358, name: "Macarrão, molho bolognesa", carbs: 22.5 },
  { id: 359, name: "Salpicão, de frango", carbs: 4.6 },
  { id: 360, name: "Tapioca, com manteiga", carbs: 63.6 },
  { id: 361, name: "Virado à paulista", carbs: 14.1 },
  { id: 362, name: "Yakisoba", carbs: 18.3 },
  { id: 363, name: "Amendoim, grão, cru", carbs: 20.3 },
  { id: 364, name: "Amendoim, torrado, salgado", carbs: 18.7 },
  { id: 365, name: "Ervilha, em vagem", carbs: 14.2 },
  { id: 366, name: "Ervilha, enlatada, drenada", carbs: 13.4 },
  { id: 367, name: "Feijão, carioca, cozido", carbs: 13.6 },
  { id: 368, name: "Feijão, carioca, cru", carbs: 61.2 },
  { id: 369, name: "Feijão, fradinho, cozido", carbs: 13.5 },
  { id: 370, name: "Feijão, fradinho, cru", carbs: 61.2 },
  { id: 371, name: "Feijão, jalo, cozido", carbs: 16.5 },
  { id: 372, name: "Feijão, jalo, cru", carbs: 61.5 },
  { id: 373, name: "Feijão, preto, cozido", carbs: 14.0 },
  { id: 374, name: "Feijão, preto, cru", carbs: 58.8 },
  { id: 375, name: "Feijão, rajado, cozido", carbs: 15.3 },
  { id: 376, name: "Feijão, rajado, cru", carbs: 62.9 },
  { id: 377, name: "Feijão, rosinha, cozido", carbs: 11.8 },
  { id: 378, name: "Feijão, rosinha, cru", carbs: 62.2 },
  { id: 379, name: "Feijão, roxo, cozido", carbs: 12.9 },
  { id: 380, name: "Feijão, roxo, cru", carbs: 60.0 },
  { id: 381, name: "Grão-de-bico, cru", carbs: 57.9 },
  { id: 382, name: "Guandu, cru", carbs: 64.0 },
  { id: 383, name: "Lentilha, cozida", carbs: 16.3 },
  { id: 384, name: "Lentilha, crua", carbs: 62.0 },
  { id: 385, name: "Paçoca, amendoim", carbs: 52.4 },
  { id: 386, name: "Pé-de-moleque, amendoim", carbs: 54.7 },
  { id: 387, name: "Soja, farinha", carbs: 38.4 },
  { id: 388, name: "Soja, extrato solúvel, pó", carbs: 28.5 },
  { id: 389, name: "Soja, queijo (tofu)", carbs: 2.1 },
  { id: 390, name: "Tremoço, cru", carbs: 43.8 },
  { id: 391, name: "Tremoço, em conserva", carbs: 12.4 },
  { id: 392, name: "Amêndoa, torrada, salgada", carbs: 29.5 },
  { id: 393, name: "Castanha-de-caju, torrada, salgada", carbs: 29.1 },
  { id: 394, name: "Castanha-do-Brasil, crua", carbs: 15.1 },
  { id: 395, name: "Farinha, de mesocarpo de babaçu, crua", carbs: 79.2 },
  { id: 396, name: "Gergelim, semente", carbs: 21.6 },
  { id: 397, name: "Linhaça, semente", carbs: 43.3 },
  { id: 398, name: "Pinhão, cozido", carbs: 43.9 },
  { id: 399, name: "Pupunha, cozida", carbs: 29.6 },
  { id: 400, name: "Noz, crua", carbs: 18.4 }
];
