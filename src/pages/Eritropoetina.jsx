      ...
      <div className="bg-white p-8 md:p-16 rounded-[4rem] shadow-2xl border border-slate-100">
        ...
        <article className="prose prose-lg max-w-none text-left">
          ...
          <div className="space-y-6 text-lg text-slate-600 font-medium leading-relaxed">
            ...
            <p>O grande perigo aqui é que, ao elevar o hematócrito além dos limites fisiológicos, o sangue fica tão "grosso" que o risco de formação de coágulos dispara. Essa viscosidade excessiva pode levar a consequências catastróficas, como o acidente vascular cerebral (AVC), o infarto agudo do miocárdio e a trombose. O que era para ser um ganho de performance acaba se tornando uma bomba-relógio para o sistema circulatório, podendo causar morte súbita em momentos de esforço intenso.</p>
            ...
            <p>Além dos perigos físicos, precisamos olhar para a ética no esporte como o pilar que sustenta qualquer competição saudável. O uso de substâncias ilícitas ou métodos proibidos quebra o princípio da igualdade e desrespeita todos os outros competidores que se dedicaram anos a fio com treinos honestos e alimentação adequada.</p>
