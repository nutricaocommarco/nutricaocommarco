        ...
        <article className="prose prose-lg max-w-none text-left">
          ...
          <div className="my-10 p-6 md:p-10 bg-green-50 rounded-3xl border border-green-100 shadow-inner flex flex-col gap-6 text-left">
            <div>
              <h2 className="text-xl md:text-2xl font-black text-green-800 uppercase italic m-0 border-b border-green-200 pb-3 flex items-center gap-2">
                <Zap className="text-green-700" /> Resposta Rápida - Quantas Calorias Gasto por Dia?
              </h2>
            ...
            <Link 
              ...
              className="inline-flex items-center justify-center gap-2 bg-slate-900 text-white px-8 py-4 rounded-full font-black uppercase tracking-widest text-sm shadow-xl hover:bg-green-700 hover:-translate-y-1 transition-all duration-300 w-full md:w-fit italic"
            >
              <Calculator size={18} />
            ...
            <nav className="bg-slate-50">
              ...
              <div className={`transition-all duration-500 ease-in-out ${isTocOpen ? 'max-h-[1000px] opacity-100 border-t border-green-100/60' : 'max-h-0 opacity-0'} overflow-hidden bg-white`}>
                <ul className="p-5 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 list-none m-0">
                  <li><a href="#o-que-e-tmb" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Zap size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />O que é TMB?</a></li>
                  <li><a href="#formulas" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Calculator size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Fórmulas de Gastos</a></li>
                  <li><a href="#percentual-gordura" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Scale size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Percentual de Gordura</a></li>
                  <li><a href="#efeito-termico" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><UtensilsCrossed size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Efeito Térmico (ETA)</a></li>
                  <li><a href="#fator-atividade" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><HeartPulse size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Fator de Atividade Física</a></li>
                  <li><a href="#o-que-sao-mets" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Flame size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />O que são os METs?</a></li>
                  <li><a href="#tabela-mets" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Target size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Tabela de METs</a></li>
          ...
          <div className="space-y-6 text-lg text-slate-600 font-medium leading-relaxed">
            ...
            <h2 id="o-que-e-tmb" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Battery className="text-green-700"/> O que é TMB?
            </h2>
            <p>
            ...
            <h2 id="formulas" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Calculator className="text-green-700"/> Fórmulas de Gastos Energéticos
            </h2>
            <p>
              ...
              <table className="w-full text-left min-w-[600px] m-0">
                ...
                <tbody className="text-sm font-medium text-slate-600 divide-y divide-slate-100">
                  ...
                  <tr className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-5 text-center text-green-700 font-bold">Sim</td>
                  </tr>
                  <tr className="hover:bg-slate-50 transition-colors">
            ...
            <h2 id="percentual-gordura" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Scale className="text-green-700"/> Como descobrir meu percentual de gordura?
            </h2>
            <p>
              ...
              <table className="w-full text-left min-w-[500px] m-0">
                ...
                <tbody className="text-sm font-medium text-slate-600 divide-y divide-slate-100">
                  <tr className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-5 text-center font-black text-green-700">20% a 30%</td>
                  </tr>
                  <tr className="hover:bg-slate-50 transition-colors">
            ...
            <h2 id="fator-atividade" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <HeartPulse className="text-green-700"/> Como calcular o Fator de Atividade Física
            </h2>
            <p>
              ...
              <table className="w-full text-left min-w-[600px] m-0">
                ...
                <tbody className="text-sm font-medium text-slate-600 divide-y divide-slate-100">
                  <tr className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-5 font-black text-green-700">1.2</td>
                  ...
                  <tr className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-5 font-black text-green-700">1.375</td>
                  ...
                  <tr className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-5 font-black text-green-700">1.55</td>
                  ...
                  <tr className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-5 font-black text-green-700">1.725</td>
                  ...
                  <tr className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-5 font-black text-green-700">1.9 a 2.2</td>
                    <td className="p-5">Treinos diários muito pesados (ex: <Link to="/nutricao_para_ironman_703" className="text-green-700 font-semibold hover:underline">triatlo</Link>), sessões duplas ou trabalho braçal extremo (construção).</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <h2 id="o-que-sao-mets" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Flame className="text-green-700"/> O que são os METs?
            </h2>
            <p>
            ...
            <h2 id="tabela-mets" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-8 border-b border-green-100 pb-2 flex items-center gap-3">
              <Target className="text-green-700"/> Tabela de METs
            </h2>
            <p className="mb-8">
            ...
            <div className="text-center mt-10 mb-8">
              <Link to="/calculadora-de-gasto-calorico" className="inline-flex items-center justify-center gap-3 bg-slate-900 text-white px-8 md:px-12 py-5 rounded-full font-black uppercase text-sm md:text-base tracking-widest shadow-xl hover:bg-green-700 hover:-translate-y-1 transition-all duration-300 w-full md:w-auto">
                <Calculator size={20} />
                Acessar Calculadora Gratuita
              </Link>
            </div>
