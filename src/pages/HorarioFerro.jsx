        ...
        <article className="prose prose-lg max-w-none text-left">
            ...
            <nav className="bg-slate-50">
              ...
              <div className={`transition-all duration-500 ease-in-out ${isTocOpen ? 'max-h-[1200px] opacity-100 border-t border-green-100/60' : 'max-h-0 opacity-0'} overflow-hidden bg-white`}>
                <ul className="p-5 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 list-none m-0">
                  <li><a href="#sintomas" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Droplet size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Sintomas de Falta de Ferro</a></li>
                  <li><a href="#como-age" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Heart size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Como o Ferro Age no Organismo</a></li>
                  <li><a href="#tempo-tratamento" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Activity size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Duração do Tratamento</a></li>
                  <li><a href="#inibidores" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><XCircle size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Alimentos que Inibem a Absorção</a></li>
                  <li><a href="#ferro-calcio" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><AlertCircle size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Ferro e Cálcio</a></li>
                  <li><a href="#vitamina-c" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Leaf size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Ferro e Vitamina C</a></li>
                  <li><a href="#ferro-zinco" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Zap size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Ferro e Zinco Juntos?</a></li>
                  <li><a href="#depois-almoco" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Utensils size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Tomar Depois do Almoço</a></li>
                  <li><a href="#jejum" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Coffee size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Tomar em Jejum</a></li>
                  <li><a href="#alimentos-ricos" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Leaf size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Alimentos Ricos em Ferro</a></li>
                  <li><a href="#heme-nao-heme" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Zap size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Heme vs Não-Heme</a></li>
                </ul>
              </div>
            </nav>
          </div>
          ...
          <div className="space-y-6 text-lg text-slate-600 font-medium leading-relaxed">
            ...
            <h2 id="sintomas" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Droplet className="text-green-700"/> Sintomas de falta de ferro no organismo
            </h2>
            <p>
            ...
            <h2 id="inibidores" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <XCircle className="text-green-700"/> Alimentos que inibem a absorção de ferro
            </h2>
            <p>
              ...
              <table className="w-full text-left border-collapse bg-white">
                <thead>
                  <tr className="bg-slate-100 text-slate-700">
                    <th className="p-4 border-b border-slate-200 font-black uppercase text-sm w-1/2"><Check className="inline w-4 h-4 text-green-700 mr-2"/> Fatores que Aumentam a Absorção</th>
            ...
            <div id="faq" className="mt-16 pt-10 border-t border-slate-100 text-left">
              <h2 className="text-2xl font-black text-slate-800 mb-8 flex items-center gap-3 italic">
                <HelpCircle className="text-green-700" /> Perguntas Frequentes sobre o Ferro (FAQ)
              </h2>
