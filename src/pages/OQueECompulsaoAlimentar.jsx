    ...
    <section className="py-12 md:py-24 bg-slate-50 px-4 md:px-6 min-h-screen font-sans">
      <div className="container mx-auto max-w-4xl bg-white p-6 md:p-16 rounded-[3rem] md:rounded-[4rem] shadow-2xl border border-slate-100">
        ...
        <article className="prose prose-lg max-w-none text-left">
          ...
          <p className="mb-4">
            Uma linha de pesquisa mais recente também investiga o papel de medicamentos como a <Link to="/tirzepatida-para-que-serve" className="text-green-700 font-bold underline">tirzepatida</Link> no controle da compulsão alimentar. A tirzepatida é um agonista duplo dos receptores GLP-1 e GIP, hoje aprovada apenas para diabetes tipo 2 e obesidade — <strong>não é aprovada para TCAP nem para nenhum transtorno alimentar</strong>. O racional é que, ao reduzir o chamado "ruído alimentar" (os pensamentos constantes sobre comida), o medicamento poderia diminuir a frequência dos episódios de compulsão.
          </p>
          <div className="bg-red-50 p-6 rounded-2xl border border-red-100 text-red-800 mt-6 mb-6">
            <p className="m-0 flex items-start gap-2"><AlertTriangle size={18} className="shrink-0 mt-0.5" /><span><strong>Evidência ainda muito preliminar:</strong> não existe, até hoje, nenhum ensaio clínico randomizado testando tirzepatida especificamente para TCAP. O único dado publicado é um estudo de caso único (uma paciente), de 2026, que combinou 3 meses de Terapia Cognitivo-Comportamental com 9 meses de tirzepatida — os episódios de compulsão, que já haviam caído durante a TCC, se mantiveram baixos durante o uso do medicamento, sem eventos adversos graves. É um resultado que abre caminho para pesquisa, não uma recomendação de tratamento: o uso é off-label e deve ser uma decisão médica individual, sempre associado ao acompanhamento psicológico.</span></p>
          </div>
          ...
          <div className="my-12 p-6 bg-slate-100 rounded-2xl border border-slate-200">
            ...
            <ul className="text-xs text-slate-600 leading-relaxed m-0 list-disc pl-4 space-y-3">
              ...
              <li><a href="https://pubmed.ncbi.nlm.nih.gov/42250261/" target="_blank" rel="noopener noreferrer" className="hover:text-green-700 hover:underline inline-block py-1">DUNFORD, A.; YEE, S.; THOMAS, J. J.; EDDY, K. T.; DECHANT, E. <em>Glucose-Dependent Insulinotropic Polypeptide/Glucagon-Like-Peptide-1 Use Following 10-Session Cognitive-Behavioural Therapy for Binge-Eating Disorder: A Single-Case Experimental Design.</em> European Eating Disorders Review, 2026.</a></li>
            </ul>
