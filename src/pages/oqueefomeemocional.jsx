    ...
    <tbody className="text-base font-medium">
      ...
      <tr>
        ...
        <td className="p-6 md:p-8 text-center"><span className="bg-red-100 text-red-700 px-3 py-1.5 rounded-full text-[10px] font-black uppercase whitespace-nowrap">Desconforto Real</span></td>
            ...
            <p>Entender o comportamento alimentar é o primeiro passo para uma vida mais equilibrada. Confira essa explicação essencial sobre por que fazemos o que fazemos com a comida.</p>
            ...
            <div className="my-10 p-6 md:p-10 bg-green-50 rounded-[3.5rem] border border-green-100 shadow-inner">
              ...
              <div className="relative w-full aspect-video rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white bg-slate-900">
                <iframe 
                  src="https://www.youtube.com/embed/S70L7h-yL5s" 
                  title="Vídeo Nutrição Comportamental" 
