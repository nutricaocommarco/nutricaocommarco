      ...
      <div className="container mx-auto max-w-4xl bg-white p-6 md:p-16 rounded-[3rem] md:rounded-[4rem] shadow-2xl border border-slate-100">
        ...
        <article className="prose prose-lg max-w-none text-left">
          ...
          <ul className="list-disc pl-5 text-slate-600 marker:text-green-700 mb-8 space-y-3">
            ...
            <li><strong>Vetores Químicos (Adsorção de Contaminantes):</strong> a <em>adsorção</em> é diferente de absorção — aqui, as substâncias químicas grudam na superfície da partícula, em vez de serem incorporadas para dentro dela. Devido à sua superfície hidrofóbica e alta razão área/volume, as partículas de microplásticos atuam como verdadeiras "esponjas químicas". Elas retêm e transportam poluição química presente na água, incluindo metais pesados e contaminantes orgânicos persistentes (como PCBs e pesticidas).</li>
          ...
          <div className="my-12 p-6 bg-slate-100 rounded-2xl border border-slate-200">
            ...
            <ul className="text-xs text-slate-600 leading-relaxed m-0 list-disc pl-4 space-y-3">
              <li><a href="https://www.scielo.br/j/qn/a/VJ58TBjHVqDZsvWLckcFbTQ/?lang=pt" target="_blank" rel="noopener noreferrer" className="hover:text-green-700 hover:underline inline-block py-1">MONTAGNER, Cassiana C.; VIDAL, Cassiana C.; ACAYABA, Guilherme R. <em>Microplásticos: ocorrência ambiental e desafios analíticos.</em> Química Nova, v. 44, n. 9, p. 1134-1152, 2021.</a></li>
              <li><a href="https://www.ijhsr.com.br/index.php/ijhsr/article/view/63" target="_blank" rel="noopener noreferrer" className="hover:text-green-700 hover:underline inline-block py-1">SILVA, Ana Clara de Oliveira et al. <em>A interferência dos microplásticos na saúde e fertilidade humana.</em> International Journal of Health and Surgical Research, v. 3, n. 2, p. 1-10, 2023.</a></li>
              <li><a href="https://www.nejm.org/doi/full/10.1056/NEJMoa2309822" target="_blank" rel="noopener noreferrer" className="hover:text-green-700 hover:underline inline-block py-1">MARFELLA, Raffaele et al. <em>Microplastics and Nanoplastics in Atheromas and Cardiovascular Events.</em> New England Journal of Medicine, 2024.</a></li>
              <li><a href="https://pubs.acs.org/doi/10.1021/acs.est.9b02540" target="_blank" rel="noopener noreferrer" className="hover:text-green-700 hover:underline inline-block py-1">HERNANDEZ, Laura M. et al. <em>Plastic Teabags Release Billions of Microparticles and Nanoparticles into Tea.</em> Environmental Science & Technology, 2019.</a></li>
              <li><a href="https://pubs.acs.org/doi/10.1021/acs.est.3c00924" target="_blank" rel="noopener noreferrer" className="hover:text-green-700 hover:underline inline-block py-1">Cutting Boards: An Overlooked Source of Microplastics in Human Food? Environmental Science & Technology, 2023.</a></li>
              <li><a href="https://research.unl.edu/blog/nebraska-study-finds-billions-of-nanoplastics-released-when-microwaving-containers/" target="_blank" rel="noopener noreferrer" className="hover:text-green-700 hover:underline inline-block py-1">HUSSAIN, Kazi Albab et al. <em>Assessing the Release of Microplastics and Nanoplastics from Plastic Containers and Reusable Food Pouches.</em> Environmental Science & Technology, 2023.</a></li>
              <li><a href="https://www.nature.com/articles/s41598-019-46417-z" target="_blank" rel="noopener noreferrer" className="hover:text-green-700 hover:underline inline-block py-1">KIM, Ji-Su et al. <em>Global Pattern of Microplastics in Commercial Food-Grade Salts.</em> Environmental Science & Technology, 2018.</a></li>
              <li><a href="https://cdn.who.int/media/docs/default-source/wash-documents/microplastics-in-dw-information-sheet190822.pdf" target="_blank" rel="noopener noreferrer" className="hover:text-green-700 hover:underline inline-block py-1">WORLD HEALTH ORGANIZATION. <em>Microplastics in Drinking-Water.</em> 2019 (atualizado em 2022).</a></li>
              <li><a href="https://doi.org/10.1038/s41591-024-03453-1" target="_blank" rel="noopener noreferrer" className="hover:text-green-700 hover:underline inline-block py-1">NIHART, Alexander J. et al. <em>Bioaccumulation of microplastics in decedent human brains.</em> Nature Medicine, 2025.</a></li>
              <li><a href="https://doi.org/10.1016/j.envint.2024.108543" target="_blank" rel="noopener noreferrer" className="hover:text-green-700 hover:underline inline-block py-1">LI, Guanjun et al. <em>Polystyrene microplastics induce anxiety via HRAS derived PERK-NF-κB pathway.</em> Environment International, 2024.</a></li>
              <li><a href="https://doi.org/10.1016/j.chemosphere.2023.139031" target="_blank" rel="noopener noreferrer" className="hover:text-green-700 hover:underline inline-block py-1">WANG, Chun-Jui; YANG, Hui-Wen; LI, Meng-Chih. <em>Association between phthalate exposure and the risk of depressive symptoms in the adult population of the United States.</em> Chemosphere, 2023.</a></li>
              <li><a href="https://doi.org/10.1016/j.envres.2015.11.021" target="_blank" rel="noopener noreferrer" className="hover:text-green-700 hover:underline inline-block py-1">KIM, Kyoung-Nam et al. <em>Urinary phthalate metabolites and depression in an elderly population: National Health and Nutrition Examination Survey 2005-2012.</em> Environmental Research, 2016.</a></li>
            </ul>
