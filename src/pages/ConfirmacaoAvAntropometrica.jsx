      ...
      <div className="bg-slate-50 min-h-screen font-sans text-slate-900">
        <section className="py-12 md:py-24 px-4 md:px-6">
          <div className="container mx-auto max-w-4xl bg-white p-6 md:p-16 rounded-[3rem] md:rounded-[4rem] shadow-2xl border border-slate-100">
            ...
            <Link to="/" className="mb-8 flex items-center gap-2 font-black uppercase tracking-widest text-slate-400 hover:text-green-700 transition-colors w-fit">
              <ChevronLeft size={20} /> Voltar para a Home
            </Link>

            {/* BANNER DE SUCESSO */}
            <div className="mb-12 p-8 md:p-12 bg-green-700 rounded-[2.5rem] shadow-xl text-center relative overflow-hidden">
              {/* Efeito de fundo */}
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div className="bg-white p-4 rounded-full mb-6 text-green-700 shadow-inner">
            ...
            <article className="prose prose-lg max-w-none text-left">
              ...
              <h2 className="text-2xl md:text-3xl font-black text-slate-800 uppercase italic mt-12 mb-8 border-b border-green-100 pb-3 flex items-center gap-3">
                <ShieldCheck className="text-green-700 w-8 h-8"/> Protocolo de Preparo Obrigatório
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                <div className="bg-slate-50 rounded-3xl p-6 md:p-8 border border-slate-200 hover:border-green-300 transition-colors shadow-sm">
                  <Coffee className="text-green-700 w-10 h-10 mb-4" />
                ...
                <div className="bg-slate-50 rounded-3xl p-6 md:p-8 border border-slate-200 hover:border-green-300 transition-colors shadow-sm">
                  <Dumbbell className="text-green-700 w-10 h-10 mb-4" />
                ...
                <div className="bg-slate-50 rounded-3xl p-6 md:p-8 border border-slate-200 hover:border-green-300 transition-colors shadow-sm">
                  <Shirt className="text-green-700 w-10 h-10 mb-4" />
                ...
                <div className="bg-slate-50 rounded-3xl p-6 md:p-8 border border-slate-200 hover:border-green-300 transition-colors shadow-sm">
                  <Droplet className="text-green-700 w-10 h-10 mb-4" />
              ...
              <h2 className="text-2xl md:text-3xl font-black text-slate-800 uppercase italic mt-12 mb-6 border-b border-green-100 pb-3 flex items-center gap-3">
                <FileText className="text-green-700 w-8 h-8"/> O Que Acontece Depois?
              </h2>
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4">
                    <a 
                      ...
                      className="inline-flex items-center justify-center gap-2 bg-green-700 text-white px-8 py-4 rounded-full font-black uppercase text-sm tracking-widest shadow-xl hover:bg-green-700 hover:-translate-y-1 transition-all w-full sm:w-auto"
                    >
