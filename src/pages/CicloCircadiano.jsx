...
const dateModifiedISO = "2026-04-06";
      ...
      <div className="bg-white p-6 md:p-16 rounded-[3rem] md:rounded-[4rem] shadow-2xl border border-slate-100">
        ...
        <article className="prose prose-lg max-w-none text-left">
          ...
          <div className="mb-8 flex flex-col items-start gap-2">
            <span className="inline-block bg-green-50 text-green-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">Fisiologia e Metabolismo</span>
            ...
            <nav className="bg-slate-50">
              ...
              <div className={`transition-all duration-500 ease-in-out ${isTocOpen ? 'max-h-[1000px] opacity-100 border-t border-green-100/60' : 'max-h-0 opacity-0'} overflow-hidden bg-white`}>
                <ul className="p-5 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 list-none m-0">
                  <li><a href="#introducao" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Clock size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Ciclo Circadiano e Emagrecimento</a></li>
                  <li><a href="#fisiologia" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Zap size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Como Funciona o Ciclo Circadiano</a></li>
                  <li><a href="#hormonios" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Activity size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Hormônios do Emagrecimento</a></li>
                  <li><a href="#ciencia" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><FileText size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Dormir Mal Engorda?</a></li>
                  <li><a href="#nutricao" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Leaf size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Crononutrição O Que É</a></li>
                  <li><a href="#tabela-sincronia" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Sun size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />O Que Comer no Café da Manhã</a></li>
                  <li><a href="#melatonina" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><ShieldCheck size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />A Verdade sobre a Melatonina</a></li>
                  <li><a href="#tabela-sono" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><Moon size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Como Dormir Rápido e Melhor</a></li>
                  <li><a href="#resumo" className="group flex items-center gap-3 text-slate-500 hover:text-green-700 transition-all font-bold text-base m-0"><CheckCircle size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Resumo do Artigo</a></li>
                </ul>
              </div>
            </nav>
          </div>
...
<figure className="my-12 rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl border border-slate-100 group flex flex-col bg-slate-200">
            <div className="relative w-full aspect-video overflow-hidden bg-slate-100">
              <ImagemOtimizada 
                ...
                title="Ciclo Circadiano e Alimentação"
            ...
            <h2 id="fisiologia" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Zap className="text-green-700"/> Como Funciona o Ciclo Circadiano no Nosso Corpo
            </h2>
            <p>
            ...
            <h2 id="hormonios" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Activity className="text-green-700"/> Hormônios do Emagrecimento: Como Baixar o Cortisol Naturalmente
            </h2>
            <p>
            ...
            <h2 id="nutricao" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Leaf className="text-green-700"/> Crononutrição O Que É: A Relação Entre Horários e Peso
            </h2>
            <p>
            ...
            <h2 id="tabela-sincronia" className="text-2xl font-black text-slate-800 uppercase italic mt-16 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Sun className="text-green-700"/> O Que Comer no Café da Manhã Para Emagrecer? (Tabela de Sincronia)
            </h2>
            ...
            <h2 id="tabela-sono" className="text-2xl font-black text-slate-800 uppercase italic mt-16 mb-6 border-b border-green-100 pb-2 flex items-center gap-3">
              <Moon className="text-green-700"/> Como Regular o Ciclo Circadiano e Dormir Rápido Naturalmente
            </h2>
            ...
            <div className="my-16 bg-white rounded-[3rem] border border-green-100 shadow-2xl overflow-hidden flex flex-col md:flex-row items-center gap-8 p-8 md:p-10 group">
              ...
              <div className="flex-1 text-center md:text-left flex flex-col justify-center">
                ...
                <p className="text-slate-600 font-medium leading-relaxed mb-8">
                  Dormiu mal e acordou com vontade de comer tudo pela frente? Baixe o meu e-book exclusivo e aprenda a diferenciar a fome física da <Link to="/o-que-e-fome-emocional" className="text-green-700 font-semibold hover:underline">fome emocional</Link>, dominando os seus sinais de saciedade.
                </p>
                <a 
            ...
            <h2 id="resumo" className="text-2xl font-black text-slate-800 uppercase italic mt-16 mb-6 border-b border-green-100 pb-2 flex items-center gap-3">
              <CheckCircle className="text-green-700"/> Resumo: O Seu Próximo Passo
            </h2>
        ...
        <div className="mt-20 p-8 md:p-10 bg-slate-50 border border-green-100 rounded-[3rem] flex flex-col md:flex-row items-center md:items-start gap-8 text-left shadow-sm">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <a href="https://instagram.com/Nutricao_com_Marco" target="_blank" rel="noopener noreferrer" className="inline-block bg-green-700 text-white px-8 py-3 rounded-2xl font-black uppercase text-xs shadow-md hover:bg-green-700 transition-all italic">
