...
import { 
  ...
  Target, Flame, Coffee, Dumbbell, Brain, Check, X, AlertTriangle, Video, PlayCircle, Apple, PieChart
} from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Descubra o que é a dieta cetogênica, como funciona o estado de cetose no organismo, o cardápio estruturado e as evidências de emagrecimento." />
        ...
        <meta property="og:description" content="Entenda as fases da cetose, os impactos metabólicos na queima de gordura, o cardápio e os mitos sobre a dieta keto." />
      ...
      <div className="container mx-auto max-w-4xl bg-white p-6 md:p-16 rounded-[3rem] md:rounded-[4rem] shadow-2xl border border-slate-100">
        ...
        <article className="prose prose-lg max-w-none text-left">
          ...
          <div className="mb-10 p-6 md:p-10 bg-green-50 rounded-3xl border border-green-100 shadow-inner flex flex-col gap-6 text-left">
            <div>
              ...
              <p className="mt-4 text-lg md:text-xl text-green-950 font-medium leading-relaxed m-0">
                A dieta cetogênica é um protocolo alimentar essencialmente hiperlipídico, no qual 70% a 80% das calorias diárias provêm do consumo de gorduras saudáveis, 15% a 20% de proteínas e há uma restrição severa de carboidratos para menos de 50 gramas por dia[cite: 4]. Ela funciona forçando o organismo a esgotar os estoques de glicogênio e reduzir os níveis de insulina[cite: 4]. Diante da falta de glicose, o fígado quebra os ácidos graxos e os converte em corpos cetônicos — como o beta-hidroxibutirato —, que passam a atuar como a fonte primária de energia para os tecidos e para o cérebro[cite: 4, 6].
              </p>
            </div>
          </div>

          <p className="text-xl text-slate-600 font-medium mb-10">
            Se você quer entender de verdade o que é dieta cetogênica sem cair em modismos ou distorções da internet, este guia foi desenhado para você. Muito associada ao emagrecimento rápido, a conhecida <Link to="/blog" className="text-green-600 font-bold hover:underline">dieta keto</Link> promove uma inversão total na pirâmide alimentar tradicional, transformando o seu corpo em uma máquina otimizada para queimar gordura como combustível[cite: 4].
          </p>
          ...
          <div className="mb-12 border border-slate-200 rounded-[2rem] shadow-sm overflow-hidden bg-slate-50">
            ...
            <div className={`transition-all duration-500 ease-in-out ${isTocOpen ? 'max-h-[1200px] opacity-100 border-t border-slate-200' : 'max-h-0 opacity-0'} overflow-hidden bg-white`}>
              <ul className="p-5 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 list-none m-0">
                ...
                <li><a href="#como-funciona" className="group flex items-center gap-3 text-slate-500 hover:text-green-600 transition-all font-bold text-base m-0"><Activity size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Como Funciona a Dieta Cetogênica</a></li>
                ...
                <li><a href="#alimentos" className="group flex items-center gap-3 text-slate-500 hover:text-green-600 transition-all font-bold text-base m-0"><Check size={16} className="text-slate-300 group-hover:text-green-500 shrink-0" />Alimentos Permitidos na Cetogênica</a></li>
          ...
          <div className="space-y-6 text-lg text-slate-600 font-medium leading-relaxed">
            ...
            <p>
              As origens dos efeitos metabólicos da cetose remontam a relatos muito antigos da humanidade. No Evangelho de Marcos (9:17-29), há a clássica passagem onde um pai desesperado pede ajuda a Jesus para curar seu filho que sofria com convulsões severas e rigidez física[cite: 4]. Ao ser questionado sobre o motivo de os discípulos não terem conseguido resolver a situação, a resposta foi enfática: <em>"Essa espécie só sai pela oração e pelo jejum"</em>[cite: 4]. O que na antiguidade era associado à purificação espiritual, na verdade baseava-se em uma profunda resposta fisiológica provocada pela privação calórica total[cite: 4].
            </p>
            <p>
              A transição para o modelo médico aconteceu em 1919, quando o Dr. John Howland recebeu uma doação de 5.000 dólares para criar um laboratório dedicado a estudar de forma sistemática os efeitos terapêuticos do jejum no tratamento de crianças com epilepsia na Universidade Johns Hopkins[cite: 4]. Os resultados na redução das crises convulsivas foram impressionantes, mas os pesquisadores enfrentavam um dilema óbvio: o ser humano não pode passar a vida inteira sem comer.
            </p>
            <p>
              Foi então que, em 1921, o Dr. Russell Wilder, trabalhando na renomada Mayo Clinic, teve um estalo genial[cite: 4]. Ele percebeu que a chave para obter os benefícios neuroprotetores do jejum consistia em induzir a produção de corpos cetônicos no sangue, mas permitindo que o paciente consumisse calorias[cite: 4]. Wilder propôs que uma dieta drasticamente rica em gorduras saudáveis e extremamente pobre em carboidratos mimetizaria perfeitamente o estado de jejum no cérebro[cite: 4]. Ele colocou seus pacientes epiléticos sob esse novo modelo e cunhou oficialmente o termo <strong>"Dieta Cetogênica"</strong>[cite: 4]. Em 1924, o pediatra Dr. Mynie Peterman estruturou as bases terapêuticas com proporções de 1g de proteína por quilo de peso e apenas 10 a 15 gramas de carboidratos por dia, obtendo resultados notáveis contra crises epilépticas[cite: 4].
            </p>
            ...
            <p>
              Para compreender <strong>como funciona a dieta cetogênica</strong>, é preciso entender a preferência energética do seu corpo. Em condições normais, a sua fonte preferencial de energia é a glicose vinda dos carboidratos. No entanto, quando você restringe drasticamente esses macronutrientes do seu <Link to="/o-que-e-ciclo-circadiano" className="text-green-600 font-bold hover:underline">dia a dia alimentar</Link>, os seus estoques internos de glicogênio hepático e muscular se esgotam em poucos dias[cite: 4].
            </p>
            <p>
              Essa escassez provoca uma queda acentuada nos níveis circulantes do hormônio insulina e uma elevação no glucagon[cite: 4]. Essa virada hormonal serve como um sinal verde para o tecido adiposo liberar ácidos graxos livres na corrente sanguínea através da lipólise[cite: 4]. Esses ácidos graxos viajam até o fígado, onde sofrem um processo chamado beta-oxidação no interior das mitocôndrias, gerando um acúmulo massivo de moléculas de Acetil-CoA[cite: 4, 6].
            </p>
            <p>
              Como o oxaloacetato (necessário para girar o ciclo de Krebs) está sendo redirecionado para a gliconeogênese a fim de manter estável a glicemia de tecidos dependentes, o excesso de Acetil-CoA se condensa e dá origem aos corpos cetônicos: o acetoacetato, a acetona e o <strong>beta-hidroxibutirato (βHB)</strong>[cite: 4, 6]. Essas moléculas atravessam a barreira hematoencefálica com extrema facilidade e passam a alimentar as células cerebrais com uma eficiência energética muito superior à da glicose[cite: 4, 6].
            </p>
            ...
            <p>
              Um erro crônico cometido por iniciantes é confundir a dieta keto com uma dieta puramente hiperproteica (como a Dieta Atkins tradicional). A verdadeira estratégia cetogênica clássica baseia-se em uma distribuição rígida de macronutrientes focada na gordura[cite: 4]. Veja a proporção correta:
            </p>
            ...
            <div className="my-8 p-6 md:p-10 bg-slate-900 rounded-[2.5rem] shadow-2xl flex flex-col md:flex-row items-center gap-8 border border-slate-800">
              <div className="flex-1 text-center md:text-left">
                ...
                <ul className="text-slate-300 font-medium space-y-3 list-none p-0 m-0">
                  <li className="flex items-center gap-2"><div className="w-3 h-3 bg-yellow-400 rounded-full shrink-0"></div> <strong>70% a 80% de Gorduras:</strong> Fonte primária de calorias[cite: 4].</li>
                  <li className="flex items-center gap-2"><div className="w-3 h-3 bg-blue-400 rounded-full shrink-0"></div> <strong>15% a 20% de Proteínas:</strong> Ingestão estritamente moderada[cite: 4].</li>
                  <li className="flex items-center gap-2"><div className="w-3 h-3 bg-green-500 rounded-full shrink-0"></div> <strong>5% a 10% de Carboidratos:</strong> Limite máximo de 31g a 50g por dia[cite: 4].</li>
                </ul>
                <p className="text-xs text-slate-400 mt-6 m-0 leading-relaxed">
                  *Nota científica: O controle proteico é necessário porque o excesso de aminoácidos pode ativar a via mTOR e gerar glicose por gliconeogênese, reduzindo a cetogênese no fígado[cite: 4].
                </p>
              </div>
            </div>
            ...
            <p>
              No entanto, nos primeiros dias de transição, é extremamente comum os pacientes apresentarem sintomas como dor de cabeça, "fog cerebral" (sensação de mente enevoada), fraqueza muscular e cãibras[cite: 4]. Esse quadro é popularmente chamado de "gripe cetogênica" e ocorre principalmente devido à queda drástica de insulina, que faz com que os rins eliminem água e sódio em grande velocidade[cite: 4].
            </p>
            <p>
              A cetoadaptação verdadeira leva semanas para se consolidar. Trata-se de uma reprogramação celular profunda onde o seu corpo aumenta a quantidade de transportadores monocarboxilatos (MCT1) no sarcolema e nas mitocôndrias, eleva a sensibilidade dos tecidos aos corpos cetônicos e aumenta a produção de enzimas responsáveis por oxidar a gordura de maneira limpa e eficiente[cite: 6].
            </p>
            ...
            <p>
              Se a sua dúvida é <strong>quanto tempo demora para entrar em cetose</strong>, a literatura científica e a prática clínica mostram uma variação grande, flutuando entre 2 e 7 dias a depender do indivíduo e do nível prévio de atividade física[cite: 4]. Mas existem estratégias validadas para acelerar esse processo de transição do metabolismo.
            </p>
            <p>
              Dados publicados no jornal científico <em>Epilepsia</em> compararam o início clássico da dieta cetogênica precedido por um jejum completo de 48 horas com uma introdução gradual sem jejum[cite: 3]. O grupo que realizou o jejum prévio acelerou drasticamente a cetose, apresentando níveis significativos de beta-hidroxibutirato já no primeiro dia[cite: 3].
            </p>
            <p>
              Na rotina clínica, a forma mais eficiente e confortável de acelerar a cetose sem a necessidade de passar dois dias em privação calórica total envolve a associação estratégica de duas ferramentas: os <strong>triglicerídeos de cadeia média (TCM)</strong> e a <strong>cafeína</strong>. Ingerir ácidos graxos de cadeia média isolados, especialmente o ácido caprílico (C8), estimula a cetogênese imediata[cite: 4]. Como o TCM é absorvido diretamente pelo sistema porta-hepático e não necessita de transporte por quilomícrons, ele chega diretamente ao fígado e é rapidamente convertido em corpos cetônicos[cite: 4, 8]. Estudos controlados em duplo-cego comprovam que adicionar cafeína potencializa a mobilização de gordura, tornando a combinação de cafeína com C8 a mais eficaz para disparar os marcadores de cetose de forma rápida e segura[cite: 4].
            </p>
            ...
            <p className="mb-6">
              Para estruturar o seu plano sem erros, a regra básica sobre <strong>alimentos permitidos na cetogênica</strong> é priorizar opções com altíssima densidade de gorduras saudáveis e praticamente zero carboidratos líquidos. Veja o guia de compras essencial:
            </p>
              ...
              <table className="w-full text-left min-w-[600px] m-0">
                ...
                <tbody className="text-sm font-medium text-slate-600 divide-y divide-slate-100">
                  ...
                  <tr className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-5">Ovos inteiros, salmão, sardinha, costela de porco, carnes bovinas com gordura natural.</td>
                  ...
                  <tr className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-5">Nozes, castanha do Pará, amêndoas, sementes de abóbora, sementes de chia e linhaça.</td>
            ...
            <h2 id="frutas" className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Apple className="text-green-600"/> Frutas Permitidas na Dieta Cetogênica: Cuidado com as Frutoses
            </h2>
            <p>
              Um dos maiores tropeços na hora de desenhar a estratégia keto é o consumo de frutas tradicionais. Como a maioria delas é rica em frutose (um carboidrato simples), consumi-las vai tirar você do estado de cetose de forma imediata. No entanto, existem <strong>frutas permitidas na dieta cetogênica</strong> que possuem um perfil lipídico e de fibras único. Veja quais incluir com moderação:
            </p>
            <p>
              O <strong>abacate</strong> e o <strong>avocado</strong> são os reis incontestáveis da dieta keto. Eles são compostos predominantemente por ácidos graxos monoinsaturados saudáveis e possuem uma quantidade de carboidratos líquidos virtualmente nula devido ao altíssimo teor de fibras vegetais. O <strong>coco seco</strong> (especialmente a polpa em pedaços) segue a mesma linha, sendo rico em gorduras saturadas de excelente qualidade. Por fim, as <strong>frutas vermelhas</strong> (como morangos, mirtilos, framboesas e amoras) podem entrar de forma controlada em pequenas porções na sua rotina diária, pois apresentam uma carga glicêmica extremamente baixa em comparação com frutas como banana ou manga.
            </p>
            ...
            <h2 className="text-2xl font-black text-slate-800 uppercase italic mt-12 mb-4 border-b border-green-100 pb-2 flex items-center gap-3">
              <Video className="text-green-600"/> Evidência Científica no Emagrecimento
            </h2>
            <p className="mb-6">
              Assista abaixo a uma revisão aprofundada dos principais estudos internacionais, incluindo dados de calorimetria e ensaios clínicos controlados, demonstrando o impacto real da dieta de restrição de carboidratos na perda de peso e na saciedade:
            </p>
            ...
            <div className="my-10 p-6 md:p-8 bg-slate-900 rounded-[2.5rem] shadow-2xl flex flex-col md:flex-row items-center gap-8 border border-slate-800">
                <div className="w-full md:w-1/2 aspect-video rounded-2xl overflow-hidden shadow-xl shrink-0 bg-black border-4 border-slate-700 relative">
                    <iframe
                        width="100%"
                        height="100%"
                        src="https://www.youtube.com/embed/exemplo_video_keto"
                        title="Evidências Científicas da Dieta Cetogênica"
                        frameBorder="0"
                ...
                <div className="flex-1 text-center md:text-left">
                    <h3 className="text-2xl font-black text-white italic uppercase mb-4 flex items-center justify-center md:justify-start gap-2">
                        <PlayCircle className="text-green-500" /> Analisando os Dados
                    </h3>
                    <p className="text-slate-300 font-medium leading-relaxed mb-6">
                      Estudos em câmaras metabólicas — como os conduzidos pelo pesquisador Kevin Hall — demonstram que, embora a perda de peso inicial na cetogênica seja rápida devido à eliminação de água ligada ao glicogênio, a perda de gordura a longo prazo depende diretamente da magnitude do déficit calórico criado no balanço final do dia[cite: 4, 5].
                    </p>
                </div>
            </div>
              ...
              <table className="w-full text-left min-w-[600px] m-0">
                ...
                <tbody className="text-sm font-medium text-slate-600 divide-y divide-slate-100">
                  <tr className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-5">80 a 120 mg/dL[cite: 4]</td>
                    <td className="p-5 text-green-700 font-bold">65 a 80 mg/dL[cite: 4]</td>
                    <td className="p-5 text-red-600 font-bold">&gt; 300 mg/dL[cite: 4]</td>
                  </tr>
                  <tr className="hover:bg-slate-50 transition-colors">
                    <td className="p-5 font-bold text-slate-800">Concentração de Cetonas</td>
                    <td className="p-5">0,1 mmol/L[cite: 4]</td>
                    <td className="p-5 text-green-700 font-bold">0,5 a 8,0 mmol/L[cite: 4]</td>
                    <td className="p-5 text-red-600 font-bold">&gt; 25 mmol/L[cite: 4]</td>
                  </tr>
                  <tr className="hover:bg-slate-50 transition-colors">
                    <td className="p-5 font-bold text-slate-800">pH do Sangue</td>
                    <td className="p-5">7.4 (Normal)[cite: 4]</td>
                    <td className="p-5 text-green-700 font-bold">7.4 (Totalmente Estável)[cite: 4]</td>
                    <td className="p-5 text-red-600 font-bold">&lt; 7.3 (Acidose Grave)[cite: 4]</td>
                  </tr>
                </tbody>
              </table>
            </div>
                ...
                <div className="flex flex-col md:flex-row items-center gap-10 mt-6 relative z-0">
                    ...
                    <div className="flex-1 text-center md:text-left flex flex-col justify-center">
                        ...
                        <p className="text-slate-600 text-sm mb-8 leading-relaxed font-medium">
                          A única maneira 100% confiável de saber se o seu cardápio está correto e se o seu corpo de fato entrou em estado de cetose é medindo os níveis de beta-hidroxibutirato no sangue[cite: 4]. Ficar apenas monitorando fitas de urina pode gerar falsos resultados após as primeiras semanas. Com o FreeStyle Optium Neo, basta uma pequena gota de sangue capilar para ter a leitura exata em segundos: se marcar de <strong>0,5 mmol/L para cima</strong>, comemore, você atingiu a cetose nutricional[cite: 4]!
                        </p>

                        <a 
                            href="https://meli.la/link_medidor_keto" 
                            target="_blank"
