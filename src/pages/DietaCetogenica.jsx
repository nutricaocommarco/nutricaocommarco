...
export default function DietaCetogenica() {
 ...
 <Helmet>
        ...
        {/* SCHEMA 1: BlogPosting (AIO Boosted) */}
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            "headline": "Dieta Cetogênica Explicada: Como Entrar em Cetose e Emagrecer",
            "image": [artigoCapa],
            "author": {
              "@type": "Person",
            ...
            "description": "O que a ciência diz sobre a Dieta Cetogênica? Entenda como o seu corpo usa a gordura como combustível e os perigos de fazer errado.",
          ...
          <div className="space-y-6 text-lg text-slate-600 font-medium leading-relaxed">
            ...
            <div className="my-8 p-6 md:p-10 bg-slate-900 rounded-[2.5rem] shadow-2xl flex flex-col md:flex-row items-center gap-8 border border-slate-800">
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-xs text-slate-400 mt-6 m-0 leading-relaxed">
                  *Nota científica sobre o que é dieta cetogênica: O controle da ingestão de proteína é fundamental. O excesso de aminoácidos aciona vias biológicas que podem gerar glicose por gliconeogênese, reduzindo a cetogênese no fígado e tirando o corpo da cetose.
                </p>
              </div>
            </div>
            ...
            <div className="my-8 overflow-x-auto bg-white rounded-3xl border border-slate-200 shadow-sm">
              <table className="w-full text-left min-w-[600px] m-0">
                <caption className="sr-only">Tabela explicativa mostrando o que é dieta cetogênica em termos de alimentos permitidos e fontes de gordura</caption>
            ...
            <figure className="my-8 rounded-3xl overflow-hidden shadow-md border border-slate-200">
              ...
              <figcaption className="bg-slate-50 p-4 text-center border-t border-slate-200">
                <p className="text-sm text-slate-600 font-medium italic m-0">
                  Sempre que pensarmos em prescrever ou criticar e explicar o que é a Dieta Cetogênica, temos que ter em mente o abismo entre os dois pratos da imagem.
                </p>
              </figcaption>
            </figure>
            ...
            <div className="my-8 overflow-x-auto bg-white rounded-3xl border border-slate-200 shadow-sm">
              <table className="w-full text-left min-w-[600px] m-0">
                <caption className="sr-only">Tabela detalhando o cardápio demonstrativo do que é dieta cetogênica em refeições completas</caption>
            ...
            <div className="mb-12 p-5 md:p-6 bg-orange-50 rounded-2xl border border-orange-100 shadow-sm flex items-start gap-3">
              ...
              <p className="text-sm md:text-base text-orange-900 font-medium italic m-0 leading-relaxed">
                <strong>Atenção:</strong> Este cardápio sobre o que é dieta cetogênica é apenas um exemplo ilustrativo e não leva em conta a sua individualidade biológica. É fundamental procurar um Nutricionista para calcular as quantidades exatas, analisar exames e montar uma estratégia segura e personalizada para você!
              </p>
            </div>
            ...
            <div className="my-8 overflow-x-auto bg-white rounded-3xl border border-slate-200 shadow-sm">
              <table className="w-full text-left min-w-[600px] m-0">
                <caption className="sr-only">Comparativo clínico explicando a diferença da cetose ao entender o que é dieta cetogênica contra a cetoacidose</caption>
                <thead className="bg-slate-50 border-b border-slate-200 text-slate-800 uppercase tracking-widest text-xs font-black">
                  <tr>
                ...
                <div className="flex flex-col md:flex-row items-center gap-10 mt-6 relative z-0">
                    ...
                    <div className="flex-1 text-center md:text-left flex flex-col justify-center">
                        ...
                        <p className="text-slate-600 text-sm mb-8 leading-relaxed font-medium">
                          A única maneira 100% confiável de saber se o seu cardápio está correto e se o seu corpo de fato entrou em estado de cetose é medindo os níveis de beta-hidroxibutirato no sangue. Ficar apenas monitorando fitas de urina pode gerar falsos resultados após as primeiras semanas entendendo o que é dieta cetogênica. Com o FreeStyle Optium Neo, basta uma pequena gota de sangue capilar para ter a leitura exata em segundos: se marcar de <strong>0,5 mmol/L para cima</strong>, comemore, você atingiu a cetose nutricional!
                        </p>
